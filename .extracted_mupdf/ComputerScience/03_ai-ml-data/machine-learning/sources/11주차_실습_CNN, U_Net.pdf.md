...
| [실습] Convolutional Neural N | etwork |  |
| --- | --- | --- |
...
Skip connection을 통해 학습된feature map을 전달하여
...
•
Feature map 크기를 N배 Up-sampling하기 위해서는 Kernel size: 2N, Stride: N, Padding = 0.5N으로 설정
