...
| Chapter  Spark 시작하기  Spark History  Spark Essentials  Spark Examples |  |  |
| --- | --- | --- |
| 컴퓨터AI공학부 | 3 | 동아대학교 |
...
| Log Mining Example  RDD operator graph를 확인 가능 |  |  |
| --- | --- | --- |
| 컴퓨터AI공학부 | 16 | 동아대학교 |
...
| Log Mining Example cache1 처리하고, 데이터캐싱 block1 cache2 block2 cache3 block3 |  |  |
| --- | --- | --- |
| 컴퓨터AI공학부 | 20 | 동아대학교 |
...
| Log Mining Example HDFS block 읽기 실행 완료 block1 block2 block3 |  |  |
| --- | --- | --- |
| 컴퓨터AI공학부 | 24 | 동아대학교 |
...
| Log Mining Example cache1 실행 완료 block1 cache2 block2 cache3 block3 |  |  |
| --- | --- | --- |
| 컴퓨터AI공학부 | 26 | 동아대학교 |
...
| 실습  Github의 README.md와 CHANGES.txt를 사용  특정 키워드를 가진 라인에 대해서 FILTER하는 RDD 생성  각 라인에 대해 Word Count를 수행  두 RDD간 조인(Join) |  |  |
| --- | --- | --- |
| 컴퓨터AI공학부 | 38 | 동아대학교 |
