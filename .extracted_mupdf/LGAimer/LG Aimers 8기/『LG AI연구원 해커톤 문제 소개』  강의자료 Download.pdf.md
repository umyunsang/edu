...
## --- [Page 2] ---
-
EXAONE 은 Global Frontier 급 Large-scale 모델과 On-Device를 지원하기 위한 Small-scale 모델이 있음
-
랩탑을 위한 2.4B, 스마트폰을 위한1.2B 모델이 있으나 더 작고 빠른 모델에 대한 요구사항이 있음
-
단순히 파라미터 수를 더 줄이면 메모리와 속도 요건은 만족하나 정확도가 크게 열화됨
-
모델 크기를 줄이고 빠르게 하면서도 정확도를 유지할 수 있는  경량화 기법을 모색하고자 과제를 제안함
...
-
On-Device 환경에서 원활히 구동할 수 있는 EXAONE 모델 지원
-
Large-scale EXAONE 모델에도 확대 적용하여 전체 서비스의 운영 비용 감소
...
https://huggingface.co/LGAI-EXAONE/EXAONE-4.0-1.2B/tree/main
...
https://huggingface.co/LGAI-EXAONE/EXAONE-4.0-1.2B/tree/main?show_file_info=model.safetensors
...
https://github.com/vllm-project/llm-compressor/blob/main/docs/guides/compression_schemes.md

https://github.com/vllm-project/llm-compressor/tree/main/examples

https://github.com/ModelCloud/GPTQModel/tree/main?tab=readme-ov-file#quantization-support

## --- [Page 11] ---
경량화 적용– 최신 모델 경향

https://huggingface.co/openai/gpt-oss-120b/blob/main/config.json#L62-L70

## --- [Page 12] ---
경량화 적용– 최신 모델 경향

https://huggingface.co/moonshotai/Kimi-K2-Thinking/blob/main/config.json#L79-L111
