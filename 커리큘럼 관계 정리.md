...
| 영역 | 대표 노트 | 관계상 역할 |
|------|-----------|-------------|
| 기초 프로그래밍 | [[ComputerScience/2-1_python/1. 변수와 자료형|Python 기초]] | AI, 리눅스, 자료구조의 공통 출발점 |
| AI 기초 | [[ComputerScience/2-1_AI/3. Backpropagation/이론/Backpropagation|Backpropagation]] | 머신러닝·뉴럴네트워크로 이어지는 핵심 개념 |
| 머신러닝 | [[ComputerScience/3-1_machine-learning/머신러닝 핵심 수학 개념|머신러닝 핵심 수학 개념]] | 선형대수·확률통계와 딥러닝 사이의 연결 |
| 시스템 | [[ComputerScience/2-2_operating-system/3. 프로세스와 프로세스 관리/프로세스와 프로세스 관리|프로세스와 프로세스 관리]] | 컴퓨터구조·리눅스에서 분산처리와 AIOSS로 이동하는 관문 |
| 알고리즘 | [[ComputerScience/4-1_algorithm/중간고사_정리|알고리즘 중간 정리]] | 자료구조·이산수학을 실전 문제해결로 연결 |
| 컴퓨터비전 | [[ComputerScience/4-1_computer-vision/중간고사_컴퓨터비전_정밀분석_정리|컴퓨터비전 정밀분석]] | 그래픽스·최적화·딥러닝의 융합 지점 |
| AIOSS | [[ComputerScience/4-1_AIOSS/md/Week0 - Orientation|AIOSS Orientation]] | 오픈소스 개발, CI/CD, 평가 워크플로우의 실행 지점 |
