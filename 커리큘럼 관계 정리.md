...
related:: [[AGENTS|AGENTS]], [[CLAUDE|CLAUDE]], [[GEMINI|GEMINI]]
...
- 루트 `README.md`는 공개 진입점으로만 유지합니다.
- 과목별 `README.md`와 `MOCs/` 폴더는 제거하고, 각 노트의 실제 내용에서 나온 `up::`, `prerequisites::`, `related::` 링크가 관계의 기준이 됩니다.
- 이 문서는 전체 흐름을 훑는 보조 지도일 뿐이며, 개별 노트의 관계를 대신하지 않습니다.
- 학습 흐름은 폴더 이름만이 아니라 선수 지식, 실습 산출물, 후속 과목 연결을 함께 반영합니다.

## 대표 노드

| 영역 | 대표 노트 | 관계상 역할 |
|------|-----------|-------------|
| 기초 프로그래밍 | [[ComputerScience/01_programming-foundations/python-programming/1. 변수와 자료형|Python 기초]] | AI, 리눅스, 자료구조의 공통 출발점 |
| AI 기초 | [[ComputerScience/03_ai-ml-data/artificial-intelligence/3. Backpropagation/이론/Backpropagation|Backpropagation]] | 머신러닝·뉴럴네트워크로 이어지는 핵심 개념 |
| 머신러닝 | [[ComputerScience/03_ai-ml-data/machine-learning/머신러닝 핵심 수학 개념|머신러닝 핵심 수학 개념]] | 선형대수·확률통계와 딥러닝 사이의 연결 |
| 시스템 | [[ComputerScience/04_systems-infrastructure/operating-systems/3. 프로세스와 프로세스 관리/프로세스와 프로세스 관리|프로세스와 프로세스 관리]] | 컴퓨터구조·리눅스에서 분산처리와 AIOSS로 이동하는 관문 |
| 알고리즘 | [[ComputerScience/06_algorithms-graphics/algorithm-design-analysis/중간고사_정리|알고리즘 중간 정리]] | 자료구조·이산수학을 실전 문제해결로 연결 |
| 컴퓨터비전 | [[ComputerScience/03_ai-ml-data/computer-vision/중간고사_컴퓨터비전_정밀분석_정리|컴퓨터비전 정밀분석]] | 그래픽스·최적화·딥러닝의 융합 지점 |
| AIOSS | [[ComputerScience/05_software-engineering/aioss-open-source-delivery/md/Week0 - Orientation|AIOSS Orientation]] | 오픈소스 개발, CI/CD, 평가 워크플로우의 실행 지점 |
