...
related:: [[ComputerScience/elective_docker-k8s/쿠버네티스  기초|쿠버네티스  기초]], [[ComputerScience/elective_docker-k8s/쿠버네티스 설치|쿠버네티스 설치]], [[ComputerScience/elective_docker-k8s/Ingress 설정 정리|Ingress 설정 정리]]
