...
related:: [[ComputerScience/elective_docker-k8s/NodePort 서비스 설정 및 가이드|NodePort 서비스 설정 및 가이드]], [[ComputerScience/elective_docker-k8s/쿠버네티스 설치|쿠버네티스 설치]], [[ComputerScience/elective_docker-k8s/Ingress 설정 정리|Ingress 설정 정리]]
