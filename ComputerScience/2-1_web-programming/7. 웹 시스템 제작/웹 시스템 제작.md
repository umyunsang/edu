...
up:: [[ComputerScience/2-1_web-programming/7. 웹 시스템 제작/web-programming__7. 웹 시스템 제작__문제 풀이|web-programming__7. 웹 시스템 제작__문제 풀이]]
prerequisites:: [[ComputerScience/2-1_python/1. 변수와 자료형|1. 변수와 자료형]]
related:: [[ComputerScience/2-1_web-programming/3. Spring Boot 기초/Spring Boot 기초 실습|Spring Boot 기초 실습]], [[ComputerScience/2-1_web-programming/1. HTML 기초/HTML 기초 실습|HTML 기초 실습]], [[ComputerScience/2-1_web-programming/4. 쿠키와 세션/쿠키와 세션|쿠키와 세션]]
