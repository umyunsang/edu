...
siblings:: [[ComputerScience/2-1_web-programming/5. 데이터베이스/MYSQL|MYSQL]], [[ComputerScience/2-1_web-programming/5. 데이터베이스/web-programming__5. 데이터베이스__확인문제|web-programming__5. 데이터베이스__확인문제]]
---
### MyController 클래스 구성
