...
related:: [[ComputerScience/2-2_OSS/1. 이벤트 이해하기/연습 문제|연습 문제]], [[ComputerScience/2-2_OSS/3. 문서 객체 모델/문서 객체 모델(DOM)|문서 객체 모델(DOM)]], [[ComputerScience/2-2_OSS/3. 문서 객체 모델/OSS__3. 문서 객체 모델__연습문제|OSS__3. 문서 객체 모델__연습문제]]
