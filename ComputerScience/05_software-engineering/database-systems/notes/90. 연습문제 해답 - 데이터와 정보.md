...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow8725913" style="font-size:14px;font-weight:600">연습문제 해답 - 데이터와 정보 단계</label>
  <div id="noteFlow8725913-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">연습문제 해답 - 데이터와 정보 핵심 개념</div>
  <input id="noteFlow8725913" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow8725913 = document.getElementById('noteFlow8725913');
    var noteFlow8725913Out = document.getElementById('noteFlow8725913-out');
    var noteFlow8725913Steps = ["연습문제 해답 - 데이터와 정보 핵심 개념","연습문제 해답 - 데이터와 정보 처리 절차","연습문제 해답 - 데이터와 정보 검증·응용"];
    noteFlow8725913.addEventListener('input', function () { noteFlow8725913Out.textContent = noteFlow8725913Steps[Number(noteFlow8725913.value) - 1]; });
  </script>
</div>
```
