...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow9186710" style="font-size:14px;font-weight:600">트랜잭션과 회복 단계</label>
  <div id="noteFlow9186710-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">트랜잭션과 회복 핵심 개념</div>
  <input id="noteFlow9186710" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow9186710 = document.getElementById('noteFlow9186710');
    var noteFlow9186710Out = document.getElementById('noteFlow9186710-out');
    var noteFlow9186710Steps = ["트랜잭션과 회복 핵심 개념","트랜잭션과 회복 처리 절차","트랜잭션과 회복 검증·응용"];
    noteFlow9186710.addEventListener('input', function () { noteFlow9186710Out.textContent = noteFlow9186710Steps[Number(noteFlow9186710.value) - 1]; });
  </script>
</div>
```
