...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow601467" style="font-size:14px;font-weight:600">1. 고급 정규형 단계</label>
  <div id="noteFlow601467-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">1. 고급 정규형 핵심 개념</div>
  <input id="noteFlow601467" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow601467 = document.getElementById('noteFlow601467');
    var noteFlow601467Out = document.getElementById('noteFlow601467-out');
    var noteFlow601467Steps = ["1. 고급 정규형 핵심 개념","1. 고급 정규형 처리 절차","1. 고급 정규형 검증·응용"];
    noteFlow601467.addEventListener('input', function () { noteFlow601467Out.textContent = noteFlow601467Steps[Number(noteFlow601467.value) - 1]; });
  </script>
</div>
```
