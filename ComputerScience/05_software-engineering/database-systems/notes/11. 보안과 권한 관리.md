...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow3380811" style="font-size:14px;font-weight:600">보안과 권한 관리 단계</label>
  <div id="noteFlow3380811-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">보안과 권한 관리 핵심 개념</div>
  <input id="noteFlow3380811" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow3380811 = document.getElementById('noteFlow3380811');
    var noteFlow3380811Out = document.getElementById('noteFlow3380811-out');
    var noteFlow3380811Steps = ["보안과 권한 관리 핵심 개념","보안과 권한 관리 처리 절차","보안과 권한 관리 검증·응용"];
    noteFlow3380811.addEventListener('input', function () { noteFlow3380811Out.textContent = noteFlow3380811Steps[Number(noteFlow3380811.value) - 1]; });
  </script>
</div>
```
