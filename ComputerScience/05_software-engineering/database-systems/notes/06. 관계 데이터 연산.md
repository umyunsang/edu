...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow760745" style="font-size:14px;font-weight:600">관계 데이터 연산 단계</label>
  <div id="noteFlow760745-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">관계 데이터 연산 핵심 개념</div>
  <input id="noteFlow760745" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow760745 = document.getElementById('noteFlow760745');
    var noteFlow760745Out = document.getElementById('noteFlow760745-out');
    var noteFlow760745Steps = ["관계 데이터 연산 핵심 개념","관계 데이터 연산 처리 절차","관계 데이터 연산 검증·응용"];
    noteFlow760745.addEventListener('input', function () { noteFlow760745Out.textContent = noteFlow760745Steps[Number(noteFlow760745.value) - 1]; });
  </script>
</div>
```
