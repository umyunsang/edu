...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow1617914" style="font-size:14px;font-weight:600">연습문제 해답 - 데이터베이스 특성 단계</label>
  <div id="noteFlow1617914-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">연습문제 해답 - 데이터베이스 특성 핵심 개념</div>
  <input id="noteFlow1617914" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow1617914 = document.getElementById('noteFlow1617914');
    var noteFlow1617914Out = document.getElementById('noteFlow1617914-out');
    var noteFlow1617914Steps = ["연습문제 해답 - 데이터베이스 특성 핵심 개념","연습문제 해답 - 데이터베이스 특성 처리 절차","연습문제 해답 - 데이터베이스 특성 검증·응용"];
    noteFlow1617914.addEventListener('input', function () { noteFlow1617914Out.textContent = noteFlow1617914Steps[Number(noteFlow1617914.value) - 1]; });
  </script>
</div>
```
