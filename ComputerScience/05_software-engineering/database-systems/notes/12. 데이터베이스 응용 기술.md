...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow3327312" style="font-size:14px;font-weight:600">데이터베이스 응용 기술 단계</label>
  <div id="noteFlow3327312-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">데이터베이스 응용 기술 핵심 개념</div>
  <input id="noteFlow3327312" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow3327312 = document.getElementById('noteFlow3327312');
    var noteFlow3327312Out = document.getElementById('noteFlow3327312-out');
    var noteFlow3327312Steps = ["데이터베이스 응용 기술 핵심 개념","데이터베이스 응용 기술 처리 절차","데이터베이스 응용 기술 검증·응용"];
    noteFlow3327312.addEventListener('input', function () { noteFlow3327312Out.textContent = noteFlow3327312Steps[Number(noteFlow3327312.value) - 1]; });
  </script>
</div>
```
