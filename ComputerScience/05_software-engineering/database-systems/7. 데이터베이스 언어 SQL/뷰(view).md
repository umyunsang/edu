...
<!-- 원본 이미지 없음: database-systems__뷰(view__뷰 생성 CREATE VIEW 문.png -->
```SQL
...
<!-- 원본 이미지 없음: database-systems__뷰(view__뷰 생성 CREATE VIEW 문 2.png -->
```SQL
...
<!-- 원본 이미지 없음: database-systems__뷰(view__뷰 활용 SELECT 문.png -->
```SQL
