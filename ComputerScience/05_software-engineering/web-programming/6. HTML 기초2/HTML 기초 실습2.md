...
```
<!-- 원본 이미지 없음: web-programming__HTML 기초 실습2__HTML 표 실습 2.png -->
- **rowspan**
 	- 행을 합치는 방법입니다.
 	- 예시:
...
```
<!-- 원본 이미지 없음: web-programming__HTML 기초 실습2__HTML 표 실습.png -->
...
---
<!-- 원본 이미지 없음: web-programming__HTML 기초 실습2__disabled.png -->
