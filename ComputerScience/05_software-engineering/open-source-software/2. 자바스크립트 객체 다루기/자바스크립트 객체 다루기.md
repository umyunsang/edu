...
<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__자바스크립트 객체.png -->
<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__자바스크립트 객체 2.png -->
- 객체 선언과 객체 생성
	<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__자바스크립트 객체 3.png -->
- 전역객체
	- ==HTML에서 최상위 객체는 window==
	- window. 은 생략 가능
		<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__자바스크립트 객체 4.png -->
...
```
- 결과
	<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__배열과 Array 객체.png -->

<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__배열과 Array 객체 2.png -->
#### ex2.html
```js
    let a1 = [0, 1, 2, 3, 4];
...
```
<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__String 객체.png -->
<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__String 객체 2.png -->
...
<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__Date 객체의 메서드 (시험에서 표는 주어질 예정.png -->
...
<!-- 원본 이미지 없음: open-source-software__자바스크립트 객체 다루기__Math 객체 (시험에 나오면 표는 주어짐.png -->
