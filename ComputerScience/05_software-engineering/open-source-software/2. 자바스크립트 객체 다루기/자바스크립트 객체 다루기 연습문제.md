...
![[open-source-software__자바스크립트 객체 다루기 연습문제__38 우측 결과가 나오도록 프로그램을 완 2 2.png]]
...
![[open-source-software__자바스크립트 객체 다루기 연습문제__40 버튼을 누르면 현재 시간이 나오는 소 2.png]]
```html
<!DOCTYPE html>
<html>
...
![[open-source-software__자바스크립트 객체 다루기 연습문제__41 우측 결과가 나오는 소스입니다. 빈 부ᄇ 2.png]]
```html
  <body>
    <h1>수학 계산기</h1>
    1. 각도 x를 입력하세요. 
