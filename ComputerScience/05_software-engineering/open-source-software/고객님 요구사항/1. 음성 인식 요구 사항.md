...
- 화면 디자인
<!-- 원본 이미지 없음: open-source-software__1. 음성 인식 요구 사항__고객 요구 사항 (1.png -->
>[!풀이]
...
<!-- 원본 이미지 없음: open-source-software__1. 음성 인식 요구 사항__고객 요구 사항 (2.png -->
>[!풀이]
...
- 몇 번 수행했는지 카운트 출력
<!-- 원본 이미지 없음: open-source-software__1. 음성 인식 요구 사항__고객 요구 사항 (3.png -->
>[!풀이]
...
- 공백제외 글자 수 출력
<!-- 원본 이미지 없음: open-source-software__1. 음성 인식 요구 사항__고객 요구 사항 (4.png -->
>[!풀이]
...
<!-- 원본 이미지 없음: open-source-software__1. 음성 인식 요구 사항__고객 요구 사항 (5.png -->
>[!풀이]
