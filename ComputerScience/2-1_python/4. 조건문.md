...
siblings:: [[ComputerScience/2-1_python/1. 변수와 자료형|1. 변수와 자료형]], [[ComputerScience/2-1_python/2. 연산자|2. 연산자]], [[ComputerScience/2-1_python/3. 반복문|3. 반복문]], [[ComputerScience/2-1_python/5. 리스트, 튜플, 딕셔너리|5. 리스트, 튜플, 딕셔너리]], [[ComputerScience/2-1_python/6. 함수|6. 함수]], [[ComputerScience/2-1_python/7. 파일 읽기와 쓰기|7. 파일 읽기와 쓰기]], [[ComputerScience/2-1_python/8. 객체 지향 프로그래밍|8. 객체 지향 프로그래밍]], [[ComputerScience/2-1_python/중간시험 범위|중간시험 범위]]
