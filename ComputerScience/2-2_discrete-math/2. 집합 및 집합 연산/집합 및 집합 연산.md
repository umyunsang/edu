...
up:: [[ComputerScience/2-2_discrete-math/1. 수학적 모델과 논리/수학적 모델과 논리|수학적 모델과 논리]]
prerequisites:: [[ComputerScience/1-2_coding-basics/중간고사|중간고사]]
related:: [[ComputerScience/2-2_discrete-math/4. 그래프/그래프|그래프]], [[ComputerScience/2-2_discrete-math/3. 관계와 함수/관계와 함수|관계와 함수]], [[ComputerScience/2-2_discrete-math/과제/과제 번역|과제 번역]]
