...
related:: [[ComputerScience/00_graph-interfaces/archive-kg/concepts/operating-systems/가상 메모리|가상 메모리]], [[ComputerScience/00_graph-interfaces/archive-kg/concepts/operating-systems/스레드 동기화|스레드 동기화]], [[ComputerScience/00_graph-interfaces/archive-kg/concepts/operating-systems/스레드와 멀티테스킹|스레드와 멀티테스킹]], [[ComputerScience/00_graph-interfaces/archive-kg/concepts/operating-systems/프로세스와 프로세스 관리|프로세스와 프로세스 관리]]
