...
related:: [[ComputerScience/00_graph-interfaces/archive-kg/concepts/operating-systems/스레드와 멀티테스킹|스레드와 멀티테스킹]], [[ComputerScience/00_graph-interfaces/archive-kg/concepts/operating-systems/프로세스와 프로세스 관리|프로세스와 프로세스 관리]]
