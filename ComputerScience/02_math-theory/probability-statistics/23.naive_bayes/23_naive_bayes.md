...
---
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정.png -->
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 2.png -->
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 3.png -->

---
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 4.png -->
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 5.png -->
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 6.png -->

---
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 7.png -->
<!-- 원본 이미지 없음: probability-statistics__23_naive_bayes__나이브 베이즈 가정 8.png -->
