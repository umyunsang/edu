...
- 멱등법칙 (idempotent law) : 연산을 여러 번 적용하더라도 결과가 달라지지 않는 성질
 <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__항등(identity) (시험 x.png -->
...
- **논리곱, 논리합, 부정, XOR 의 진리표** ==(암기)==
 <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Operation (논리 연산.png -->
 <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Operation (논리 연산 3.png -->
- **합성 명제 진리표 예제**
 <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Operation (논리 연산 2.png -->
 <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Operation (논리 연산 4.png -->

#### Logical Implication (논리 함축)

<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Implication (논리 함축 2.png -->
...
- **논리 함축 (Implication)**
  ...
  <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Implication (논리 함축.png -->
 	...
 	- ==솔루션을 적는 문제 나올 수 있음==<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Implication (논리 함축 3.png --><!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Implication (논리 함축 4.png --><!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Implication (논리 함축 5.png -->

#### Logical Equivalences (논리적 동치) (시험 x)

<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Equivalences (논리적 동치) (시험 x.png -->

- **논리적 동치**
 	- 임의의 명제 P와 Q에 대해서 논리적 동치 P⇔Q의 진리값은 P와 Q가 모두 참이거나 모두 거짓일 경우에만 참이 되고, 그 이외의 경우에는 모두 거짓이 된다
 	- P⇔Q는 논리 함축 P→Q와 논리 함축 Q→P의 논리곱이다
  <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Logical Equivalences (논리적 동치) (시험 x 2.png -->
...
<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__Operator precedence 연산자 우선 순위표 (우선순위.png -->
...
<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__한정자(quantifier.png -->
<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__한정자(quantifier 2.png -->
...
<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__논리적 추론을 위한 기본 법칙.png -->
<!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__논리적 추론을 위한 기본 법칙 2.png -->
- 시험 문제
 <!-- 원본 이미지 없음: discrete-mathematics__수학적 모델과 논리__논리적 추론을 위한 기본 법칙 3.png -->
