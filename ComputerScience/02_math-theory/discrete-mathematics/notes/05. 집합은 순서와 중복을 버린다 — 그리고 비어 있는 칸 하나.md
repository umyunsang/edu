...
> 같은 줄이 *"(Relations will be covered in depth in **Chapter 9**.)"*라고 덧붙이는데, 이 자료는 3장이고 다음 자료는 「4 관계 및 함수」다. 영어 슬라이드가 원 교재(로젠 8판)의 장 번호를 그대로 달고 온 것이다. 01번 노트에서 본 강의계획의 어긋남과 같은 종류다.
