...
- 집합의 크기란 집합의 크기를 나타내는 수로 기수로 표시한다
	<!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__Cardinality of Set (집합의 크기.png -->
#### Power set (멱집합)
...
<!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__Cartesian Product (곱집합.png -->
<!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__Cartesian Product (곱집합 2.png -->

## 2. 집합의 연산

#### 대칭 차집합(symmetric difference) : A⊕B
<!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__대칭 차집합(symmetric difference) A⊕B.png -->

#### Duality(쌍대)

<!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__Duality(쌍대.png --><!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__Duality(쌍대 2.png -->
...
<!-- 원본 이미지 없음: discrete-mathematics__집합 및 집합 연산__Duality(쌍대 3.png -->
