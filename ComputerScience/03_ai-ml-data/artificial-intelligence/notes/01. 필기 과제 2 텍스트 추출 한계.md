...
확인 가능한 본문이 없거나 판독이 불안정한 상태에서는 수식·지시문·예시를 추정해 적지 않는다. 이 문서는 과제의 대체 해설이 아니라, 재구성 가능한 근거의 범위를 기록한다.
...
<div style="font-family:system-ui,sans-serif;padding:16px;border:1px solid var(--border);background:var(--card);color:var(--foreground);border-radius:var(--radius)">
  <div style="font-weight:700;margin-bottom:10px">01. 필기 과제 2 텍스트 추출 한계 · 점검 흐름</div>
...
판독이 불안정한 자료에서 실제 과제 요구를 추정하지 않아야 하는 이유는 무엇인가? 추가 텍스트가 확보되면 어떤 항목부터 문서화해야 하는가?
