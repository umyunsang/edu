...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow756056" style="font-size:14px;font-weight:600">Windows AI 개발환경 구성 단계</label>
  <div id="noteFlow756056-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">Windows AI 개발환경 구성 핵심 개념</div>
  <input id="noteFlow756056" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow756056 = document.getElementById('noteFlow756056');
    var noteFlow756056Out = document.getElementById('noteFlow756056-out');
    var noteFlow756056Steps = ["Windows AI 개발환경 구성 핵심 개념","Windows AI 개발환경 구성 처리 절차","Windows AI 개발환경 구성 검증·응용"];
    noteFlow756056.addEventListener('input', function () { noteFlow756056Out.textContent = noteFlow756056Steps[Number(noteFlow756056.value) - 1]; });
  </script>
</div>
```
