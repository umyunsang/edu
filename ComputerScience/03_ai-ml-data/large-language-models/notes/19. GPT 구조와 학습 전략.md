...
```html preview
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow622658" style="font-size:14px;font-weight:600">GPT 구조와 학습 전략 단계</label>
  <div id="noteFlow622658-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">GPT 구조와 학습 전략 핵심 개념</div>
  <input id="noteFlow622658" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow622658 = document.getElementById('noteFlow622658');
    var noteFlow622658Out = document.getElementById('noteFlow622658-out');
    var noteFlow622658Steps = ["GPT 구조와 학습 전략 핵심 개념","GPT 구조와 학습 전략 처리 절차","GPT 구조와 학습 전략 검증·응용"];
    noteFlow622658.addEventListener('input', function () { noteFlow622658Out.textContent = noteFlow622658Steps[Number(noteFlow622658.value) - 1]; });
  </script>
</div>
```
