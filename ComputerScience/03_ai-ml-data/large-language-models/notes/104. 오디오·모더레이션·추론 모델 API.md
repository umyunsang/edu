...
**핵심:** 모더레이션은 텍스트나 이미지 입력이 잠재적으로 해로운지 분류해 필터링이나 계정 개입 같은 후속 조치를 돕는다.
...
<Tabs>
  ...
  <Tab label="후속 조치">결과를 서비스 정책과 결합해 필터링·검토·계정 개입을 결정한다.</Tab>
</Tabs>
...
- 모더레이션 결과는 자동 조치가 아니라 서비스 정책과 검토 절차의 입력이다.
