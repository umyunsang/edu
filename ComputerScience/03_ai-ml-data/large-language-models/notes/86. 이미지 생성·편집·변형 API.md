...
| n | 생성 결과 수 | 기본값 1, DALL·E 2 설명에서 최대 10 |
...
원문 예시는 DALL·E 2, 512×512, standard, 1개 결과를 사용한다.
...
| 입력 | 원문 조건 | 의미 |
| :-- | :-- | :-- |
| image | 4MB 미만 정사각형 PNG | 편집할 원본 |
| mask | 4MB 미만 정사각형 RGBA PNG | 투명 영역으로 변경 위치 지정 |
| prompt | 텍스트 설명 | 편집 영역에 반영할 내용 |
| n, size | 결과 수와 크기 | 실습은 1개, 1024×1024 |
