...
## LLM 모델 이해
#### 자연어처리(NLP) 기술의 발전
<!-- 원본 이미지 없음: elective_LLM__Pasted image 20250120101836.png -->
...
<!-- 원본 이미지 없음: elective_LLM__Pasted image 20250120103621.png -->
...
<!-- 원본 이미지 없음: elective_LLM__Pasted image 20250120111923.png -->
...
##### Attention Mechanism
<!-- 원본 이미지 없음: elective_LLM__Pasted image 20250120112057.png -->
