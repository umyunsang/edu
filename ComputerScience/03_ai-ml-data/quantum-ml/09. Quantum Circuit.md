...
> [!quote] 슬라이드 근거
> `pdf/day10_01_quantum_circuit_lecture.pdf` p.2
...
> [!quote] 슬라이드 근거
> `pdf/day10_01_quantum_circuit_lecture.pdf` p.5
...
> [!quote] 슬라이드 근거
> `pdf/day10_01_quantum_circuit_lecture.pdf` p.4
...
> [!quote] 슬라이드 근거
> `pdf/day10_01_quantum_circuit_lecture.pdf` p.6
...
- **uses** — [07. 상태변화 분석](<./07. 상태변화 분석.md>) : Gate 순서가 결과를 바꾸는 것을 실측한 노트
- **applies-to** — [10. Quantum Circuit과 QML](<./10. Quantum Circuit과 QML.md>) : 이 회로에 학습 가능한 부분을 붙여 QML 회로로 만든다
- **uses** — [04. Quantum Feature Space](<./04. Quantum Feature Space.md>) : $2^{n}$ 공간이 왜 유용한지를 다룬다
...
- `pdf/day10_01_quantum_circuit_lecture.pdf` (7p)
