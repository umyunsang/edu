...
prerequisites:: [[08. Quantum Gate 개념]]
next:: [[10. Quantum Circuit과 QML]]
...
> [[07. 상태변화 분석|앞 노트]]에서 $XH$ 와 $HX$ 를 구분한 이유가 여기서도 그대로 적용된다.
...
> [!tip] 다음 노트
> [[10. Quantum Circuit과 QML]] 에서 이 세 부분을 실제로 조립해
> **첫 QML 회로**를 만든다.
