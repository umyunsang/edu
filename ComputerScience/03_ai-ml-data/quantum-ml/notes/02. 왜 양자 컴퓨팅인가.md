...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="amt" style="font-size:14px;font-weight:600">문제 크기 </label>
  <div id="out" style="font-size:30px;font-weight:700;color:var(--chart-1);margin:6px 0">16</div>
  <input id="amt" type="range" min="2" max="128" step="2" value="16"
    style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">문제 크기는 알고리즘 복잡도를 논의할 출발점이다.</p>
  <script>
