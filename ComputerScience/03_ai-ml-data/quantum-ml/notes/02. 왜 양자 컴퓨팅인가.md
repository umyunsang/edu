...
<svg viewBox="0 0 720 132" width="100%" role="img" aria-label="AI와 계산 기반의 변화가 새 문제와 함께 확장되는 독자 제작 시간 흐름"><text x="18" y="23" font-size="15" font-weight="700" fill="currentColor">계산 패러다임은 이전 기술을 지우기보다 풀 수 있는 문제의 경계를 넓힌다</text><g transform="translate(34 52)" font-family="system-ui,sans-serif"><line x1="20" y1="27" x2="632" y2="27" stroke="var(--border)" stroke-width="4"/><g><circle cx="44" cy="27" r="18" fill="var(--chart-1)"/><text x="44" y="32" text-anchor="middle" font-size="13" font-weight="700" fill="white">규칙</text><circle cx="190" cy="27" r="18" fill="var(--chart-2)"/><text x="190" y="32" text-anchor="middle" font-size="13" font-weight="700" fill="white">학습</text><circle cx="336" cy="27" r="18" fill="var(--chart-4)"/><text x="336" y="32" text-anchor="middle" font-size="13" font-weight="700" fill="white">심층</text><circle cx="482" cy="27" r="18" fill="var(--chart-3)"/><text x="482" y="32" text-anchor="middle" font-size="13" font-weight="700" fill="white">생성</text><circle cx="628" cy="27" r="18" fill="var(--chart-5)"/><text x="628" y="32" text-anchor="middle" font-size="12" font-weight="700" fill="white">Q+AI</text></g><text x="336" y="83" text-anchor="middle" font-size="12" fill="var(--muted-foreground)">새 계산 자원은 모델·데이터·알고리즘의 선택지 중 하나를 바꾼다</text></g></svg>
</div>
```
...
```html preview h=175
<div style="font-family:system-ui,sans-serif;padding:14px;color:var(--foreground);background:var(--card);border:1px solid var(--border);border-radius:var(--radius)">
<svg viewBox="0 0 720 128" width="100%" role="img" aria-label="고전 비트가 두 가지 구별 가능한 물리 상태로 정보를 나타내는 독자 제작 도식"><text x="18" y="23" font-size="15" font-weight="700" fill="currentColor">비트는 서로 확실히 구분할 수 있는 두 상태에 정보를 싣는다</text><g transform="translate(163 52)" font-family="system-ui,sans-serif"><g><rect width="142" height="55" rx="12" fill="var(--card)" stroke="var(--border)"/><circle cx="34" cy="27" r="14" fill="var(--muted-foreground)"/><text x="86" y="32" text-anchor="middle" font-size="18" font-weight="700" fill="currentColor">0</text></g><path d="M160 27h104" stroke="var(--muted-foreground)" stroke-width="3"/><path d="M264 27l-10-7v14z" fill="var(--muted-foreground)"/><text x="212" y="16" text-anchor="middle" font-size="12" fill="var(--muted-foreground)">물리적 구분</text><g transform="translate(280)"><rect width="142" height="55" rx="12" fill="var(--card)" stroke="var(--border)"/><circle cx="34" cy="27" r="14" fill="var(--chart-3)"/><text x="86" y="32" text-anchor="middle" font-size="18" font-weight="700" fill="currentColor">1</text></g></g></svg>
</div>
```
...
```html preview h=185
<div style="font-family:system-ui,sans-serif;padding:14px;color:var(--foreground);background:var(--card);border:1px solid var(--border);border-radius:var(--radius)">
<svg viewBox="0 0 720 138" width="100%" role="img" aria-label="계산 수요와 물리적 자원, 알고리즘 표현의 긴장이 새 계산 접근을 부르는 독자 제작 도식"><text x="18" y="23" font-size="15" font-weight="700" fill="currentColor">양자 컴퓨팅은 특정 문제에서 계산 표현을 바꿔 보려는 연구 방향이다</text><g transform="translate(44 51)" font-family="system-ui,sans-serif"><g><rect width="162" height="58" rx="11" fill="var(--card)" stroke="var(--border)"/><text x="81" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">계산 수요</text><text x="81" y="43" text-anchor="middle" font-size="11" fill="var(--muted-foreground)">모델·데이터·최적화</text></g><g transform="translate(250)"><rect width="162" height="58" rx="11" fill="var(--card)" stroke="var(--border)"/><text x="81" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">물리 자원</text><text x="81" y="43" text-anchor="middle" font-size="11" fill="var(--muted-foreground)">시간·전력·메모리</text></g><g transform="translate(456)"><rect width="162" height="58" rx="11" fill="var(--chart-4)"/><text x="81" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="white">새 표현 탐색</text><text x="81" y="43" text-anchor="middle" font-size="11" fill="white">양자 상태·측정</text></g><path d="M206 29h38M412 29h38" stroke="var(--muted-foreground)" stroke-width="3"/></g></svg>
</div>
```
