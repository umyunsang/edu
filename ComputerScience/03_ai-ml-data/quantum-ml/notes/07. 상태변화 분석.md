...
<svg viewBox="0 0 720 138" width="100%" role="img" aria-label="고전 비트의 두 상태와 측정 전 양자 상태의 진폭을 대조하는 독자 제작 도식"><text x="18" y="23" font-size="15" font-weight="700" fill="currentColor">상태는 저장된 숫자가 아니라 다음 측정 결과의 가능성 구조다</text><g transform="translate(75 51)" font-family="system-ui,sans-serif"><g><rect width="208" height="58" rx="11" fill="var(--card)" stroke="var(--chart-1)" stroke-width="2"/><text x="104" y="23" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">고전 bit</text><text x="104" y="43" text-anchor="middle" font-size="15" fill="var(--chart-1)">0 또는 1</text></g><path d="M310 29h95" stroke="var(--muted-foreground)" stroke-width="3"/><path d="M405 29l-10-7v14z" fill="var(--muted-foreground)"/><g transform="translate(430)"><rect width="208" height="58" rx="11" fill="var(--card)" stroke="var(--chart-4)" stroke-width="2"/><text x="104" y="23" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">qubit</text><text x="104" y="43" text-anchor="middle" font-size="15" fill="var(--chart-4)">α|0⟩ + β|1⟩</text></g></g></svg>
</div>
```
...
```html preview h=185
<div style="font-family:system-ui,sans-serif;padding:14px;color:var(--foreground);background:var(--card);border:1px solid var(--border);border-radius:var(--radius)">
<svg viewBox="0 0 720 138" width="100%" role="img" aria-label="H 게이트가 한 기준 상태를 두 결과의 진폭을 갖는 상태로 바꾸는 독자 제작 도식"><text x="18" y="23" font-size="15" font-weight="700" fill="currentColor">게이트는 값을 대입하는 명령이 아니라 상태 벡터를 회전시키는 연산이다</text><g transform="translate(108 51)" font-family="system-ui,sans-serif"><g><circle cx="55" cy="29" r="27" fill="var(--chart-1)"/><text x="55" y="36" text-anchor="middle" font-size="19" font-weight="700" fill="white">|0⟩</text></g><path d="M102 29h92" stroke="var(--muted-foreground)" stroke-width="3"/><path d="M194 29l-10-7v14z" fill="var(--muted-foreground)"/><rect x="210" y="3" width="59" height="52" rx="11" fill="var(--chart-4)"/><text x="239" y="37" text-anchor="middle" font-size="20" font-weight="700" fill="white">H</text><path d="M283 29h92" stroke="var(--muted-foreground)" stroke-width="3"/><path d="M375 29l-10-7v14z" fill="var(--muted-foreground)"/><g transform="translate(396)"><rect width="160" height="58" rx="11" fill="var(--card)" stroke="var(--border)"/><text x="80" y="25" text-anchor="middle" font-size="15" font-weight="700" fill="currentColor">중첩 상태</text><text x="80" y="44" text-anchor="middle" font-size="12" fill="var(--muted-foreground)">측정 전 가능성의 결합</text></g></g></svg>
</div>
```
...
```html preview h=185
<div style="font-family:system-ui,sans-serif;padding:14px;color:var(--foreground);background:var(--card);border:1px solid var(--border);border-radius:var(--radius)">
<svg viewBox="0 0 720 138" width="100%" role="img" aria-label="두 게이트를 적용하는 순서가 바뀌면 결과가 달라질 수 있음을 보여주는 독자 제작 비교 도식"><text x="18" y="23" font-size="15" font-weight="700" fill="currentColor">양자 게이트는 일반적으로 순서를 바꾸면 같은 결과가 되지 않는다</text><g transform="translate(86 52)" font-family="system-ui,sans-serif"><g><text x="76" y="0" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">순서 A</text><line x1="0" y1="27" x2="212" y2="27" stroke="var(--border)" stroke-width="3"/><rect x="43" y="3" width="45" height="48" rx="9" fill="var(--chart-1)"/><text x="66" y="34" text-anchor="middle" font-size="16" font-weight="700" fill="white">U</text><rect x="126" y="3" width="45" height="48" rx="9" fill="var(--chart-4)"/><text x="149" y="34" text-anchor="middle" font-size="16" font-weight="700" fill="white">V</text><text x="106" y="82" text-anchor="middle" font-size="13" fill="var(--muted-foreground)">V·U|ψ⟩</text></g><path d="M253 28h88" stroke="var(--muted-foreground)" stroke-width="3"/><path d="M341 28l-10-7v14z" fill="var(--muted-foreground)"/><g transform="translate(388)"><text x="76" y="0" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">순서 B</text><line x1="0" y1="27" x2="212" y2="27" stroke="var(--border)" stroke-width="3"/><rect x="43" y="3" width="45" height="48" rx="9" fill="var(--chart-4)"/><text x="66" y="34" text-anchor="middle" font-size="16" font-weight="700" fill="white">V</text><rect x="126" y="3" width="45" height="48" rx="9" fill="var(--chart-1)"/><text x="149" y="34" text-anchor="middle" font-size="16" font-weight="700" fill="white">U</text><text x="106" y="82" text-anchor="middle" font-size="13" fill="var(--muted-foreground)">U·V|ψ⟩</text></g></g></svg>
</div>
```
...
- **applies** — [03. Bit와 Qubit](<./03. Bit와 Qubit.md>) : 여기서 세운 Bit · Qubit 대조를 그대로 가져온다
- **applies** — [05. QML에서 Quantum의 역할](<./05. QML에서 Quantum의 역할.md>) : Gate 순서가 Feature Transformation으로 이어지는 지점
- **elaborates** — [08. Quantum Gate 개념](<./08. Quantum Gate 개념.md>) : 개별 실습을 유니터리 연산이라는 일반 틀로 묶는다
