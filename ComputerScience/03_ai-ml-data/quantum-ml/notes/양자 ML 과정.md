...
> [!info] 강의 정리문서는 인덱스에서
> 원본 강의 PDF를 근거로 재작성한 정리문서 10편은 [00. 양자 ML 인덱스](<../README.md>) 에 모여 있다.
...
- [표현력의 한계](<../sources/day01_02_expressive_power_limit_lecture.pdf>)
- [Quantum Computing이 필요한가](<../sources/day02_01_why_quantum_computing_lecture.pdf>)
...
- [Bit와 Qubit](<../sources/day02_02_bit_and_qubit_lecture.pdf>)
...
- [Hadamard Gate 개념 이해](<../sources/day05_03_hadamard_gate_concepts_lecture.pdf>)
- [상태변화 분석](<../sources/day05_04_quantum_state_transition_analysis_lecture.pdf>)
...
- [Quantum Gate 개념](<../sources/day08_01_quantum_gate_concepts_lecture.pdf>)
...
- [Quantum Circuit 이란 ?](<../sources/day10_01_quantum_circuit_lecture.pdf>)
...
- [Quantum Circuit과 QML](<../sources/day11_04_quantum_circuit_and_qml_lecture.pdf>)
...
- [Quantum Feature Space](<../sources/day02_03_quantum_feature_space_lecture.pdf>)
- [QML에서 Quantum의 역할](<../sources/day02_04_quantum_role_in_qml_lecture.pdf>)
