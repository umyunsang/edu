...
- **generalizes** — [08. Quantum Gate 개념](<./08. Quantum Gate 개념.md>) : H를 포함한 게이트 일반을 다룬다
- **applies-to** — [07. 상태변화 분석](<./07. 상태변화 분석.md>) : 여기 개념을 실제 코드로 확인하는 노트
- **applies-to** — [04. Quantum Feature Space](<./04. Quantum Feature Space.md>) : H가 열어준 공간을 본격적으로 다룬다
