...
> [!quote] 슬라이드 근거
> `pdf/day08_01_quantum_gate_concepts_lecture.pdf` p.2
...
> [!quote] 슬라이드 근거
> `pdf/day08_01_quantum_gate_concepts_lecture.pdf` p.3–4
...
> [!quote] 슬라이드 근거
> `pdf/day08_01_quantum_gate_concepts_lecture.pdf` p.5
...
> [!quote] 슬라이드 근거
> `pdf/day08_01_quantum_gate_concepts_lecture.pdf` p.6
...
- **applies-to** — [07. 상태변화 분석](<./07. 상태변화 분석.md>) : 여기 게이트들을 실제 코드로 조합해 본다
- **applies-to** — [09. Quantum Circuit](<./09. Quantum Circuit.md>) : 게이트를 나열해 회로를 만드는 단계
- **uses** — [05. QML에서 Quantum의 역할](<./05. QML에서 Quantum의 역할.md>) : Feature Transformation 도구라는 규정이 여기서 온다
