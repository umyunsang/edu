...
prerequisites:: [[07. 상태변화 분석]]
next:: [[09. Quantum Circuit]]
related:: [[06. Hadamard Gate]]

# 08. Quantum Gate 개념

> [!abstract] 한 줄 요약
> [[06. Hadamard Gate|H 게이트]]를 개별 사례로 봤다면, 여기서는 **게이트 일반**을 정리한다.
...
> [[05. QML에서 Quantum의 역할|Feature Map]]이 고정, Variational Circuit이 학습인 이유가 여기 있다.
