...
source:: [day05_03_hadamard_gate_concepts_lecture.pdf](<01.quantum-foundations/03.gates-measurement-and-entanglement/day05_03_hadamard_gate_concepts_lecture.pdf>)
prerequisites:: [03. Bit와 Qubit](<03. Bit와 Qubit.md>)
next:: [07. 상태변화 분석](<07. 상태변화 분석.md>)
related:: [08. Quantum Gate 개념](<08. Quantum Gate 개념.md>)
...
> 뒤이은 간섭에서 결과를 가른다. [07. 상태변화 분석](<07. 상태변화 분석.md>) 의 실습이 정확히 이 지점을 보여준다.
...
> [Feature Map](<05. QML에서 Quantum의 역할.md>) 회로에서 H가 선두에 배치되는 이유다.
