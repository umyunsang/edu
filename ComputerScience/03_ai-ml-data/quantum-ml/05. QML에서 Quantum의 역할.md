...
- **uses** — [06. Hadamard Gate](<./06. Hadamard Gate.md>) : Feature Map 회로 먼 앞에 서는 H 게이트
- **applies-to** — [10. Quantum Circuit과 QML](<./10. Quantum Circuit과 QML.md>) : 여기서 만든 Feature Map 뒤에 Ansatz를 붙여 실제 QML 회로를 완성한다
