...
source:: [day02_01_why_quantum_computing_lecture.pdf](<01.quantum-foundations/01.why-quantum-and-qml/day02_01_why_quantum_computing_lecture.pdf>)
prerequisites:: [01. 표현력의 한계](<01. 표현력의 한계.md>)
next:: [03. Bit와 Qubit](<03. Bit와 Qubit.md>)

> [!abstract] 한 줄 요약
> [앞 노트](<01. 표현력의 한계.md>)가 **모델의 한계**를 보였다면, 이 노트는 **계산 기반 자체의 한계**를 본다.
...
> [!tip] 다음 노트로 넘어가기 전에
> 여기까지가 **"왜"** 다. 다음 [03. Bit와 Qubit](<03. Bit와 Qubit.md>) 부터는 **"무엇으로"** 로 넘어간다.
