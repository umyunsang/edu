...
| # | 노트 | 다루는 것 |
| :-- | :-- | :-- |
| 01 | [표현력의 한계](<./01. 표현력의 한계.md>) | XOR 데이터로 선형 모델이 무너지는 것을 직접 확인 |
| 02 | [왜 양자 컴퓨팅인가](<./02. 왜 양자 컴퓨팅인가.md>) | 고전 컴퓨팅과의 근본적 차이 |
| 03 | [Bit와 Qubit](<./03. Bit와 Qubit.md>) | 값과 상태의 구분 |
| 04 | [Quantum Feature Space](<./04. Quantum Feature Space.md>) | 데이터가 도착하는 고차원 공간 |
| 05 | [QML에서 Quantum의 역할](<./05. QML에서 Quantum의 역할.md>) | Encoding → Feature Map → Variational → Measurement 4단계 |
| 06 | [Hadamard Gate](<./06. Hadamard Gate.md>) | 중첩을 만드는 가장 기본 게이트 |
| 07 | [상태변화 분석](<./07. 상태변화 분석.md>) | Gate 추가·반복·순서가 상태를 바꾸는 방식 |
| 08 | [Quantum Gate 개념](<./08. Quantum Gate 개념.md>) | 유니터리 연산과 대표 게이트 5종 |
| 09 | [Quantum Circuit](<./09. Quantum Circuit.md>) | 게이트를 순서대로 나열한 계산 구조 |
| 10 | [Quantum Circuit과 QML](<./10. Quantum Circuit과 QML.md>) | Feature Map + Ansatz 로 첫 QML 회로 조립 |
...
- **prerequisite** — [신경망 인덱스](<../neural-networks/00. 신경망 인덱스.md>) : 고전 신경망의 학습 구조를 알면 Variational Circuit이 쉽게 읽힌다
- **uses** — [양자 ML 과정](<./양자 ML 과정.md>) : 전체 과정 개요와 모듈 구성
