...
> [!quote] 슬라이드 근거
> `pdf/day11_04_quantum_circuit_and_qml_lecture.pdf` p.4
...
> [!quote] 슬라이드 근거
> `pdf/day11_04_quantum_circuit_and_qml_lecture.pdf` p.16
...
- **uses** — [05. QML에서 Quantum의 역할](<./05. QML에서 Quantum의 역할.md>) : 여기서 다룬 Feature Map을 앞단에 그대로 갖다 쓴다
- **uses** — [04. Quantum Feature Space](<./04. Quantum Feature Space.md>) : 인코딩이 도착하는 공간이 왜 고차원인지의 근거
...
- `pdf/day11_04_quantum_circuit_and_qml_lecture.pdf` (17p)
