...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  ...
  <div id="flow3107472957-out" style="font-size:24px;font-weight:700;color:var(--chart-1);margin:6px 0">자료 없음</div>
  <input id="flow3107472957" type="range" min="1" max="1" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
