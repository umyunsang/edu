...
* [RNN·LSTM 실습](./01.%20RNN%C2%B7LSTM%20%EC%8B%A4%EC%8A%B5.md) - 훈민정음 문장을 one-hot sequence로 바꾸고 RNN·LSTM으로 예측하는 실습 흐름을 정리한다.
...
* [RNN과 LSTM의 순환 구조](./01.%20RNN%EA%B3%BC%20LSTM%EC%9D%98%20%EC%88%9C%ED%99%98%20%EA%B5%AC%EC%A1%B0.md) - 시계열 hidden state, BPTT와 장기 의존성, LSTM cell state와 gate를 정리한다.
...
* [초해상도와 SRCNN](./01.%20%EC%B4%88%ED%95%B4%EC%83%81%EB%8F%84%EC%99%80%20SRCNN.md) - 보간 기반 초해상도의 한계와 SRCNN의 데이터 구성, 학습, PSNR 평가 흐름을 정리한다.
