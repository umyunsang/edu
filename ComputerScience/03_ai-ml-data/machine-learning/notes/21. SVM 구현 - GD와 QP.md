...
$$
\mathrm{margin}=\frac{2}{\lVert w\rVert_2}
$$
...
| 비선형 마진 계산 | 없음 | $2/\lVert w\rVert$ 결과로 확장하지 않음 |
...
> [!WARNING]
>
> - **표기 오류:** 자료에는 “Gradient Decent”, “Qudratic” 표기가 반복된다.
> - **미분 부호:** 위반 구간에서 $\partial L/\partial b=y_i$라고 적지만, 제시된 손실을 미분한 부호와 맞지 않는다.
> - **QP 경계:** `SVC` 예시는 사용 표면이며 커널 행렬과 쌍대 변수를 직접 구현한 증거가 아니다.
>
