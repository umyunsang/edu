...
> [!IMPORTANT]
>
> 아래 층 크기와 채널 수는 원본 U-Net 구조 슬라이드에 표시된 값만 옮겼다. 전체 슬라이드가 아니라 구조를 읽는 데 필요한 영역만 아래에 크롭했다.
>
> **U-Net encoder–decoder 구조 도식**
>
> ![U-Net encoder–decoder 구조 도식 크롭](../assets/u-net-architecture-crop.webp)
>
> _encoder의 압축, skip connection, decoder의 복원 경로를 한눈에 확인한다._
>
> <!-- provenance: source=11주차_실습_CNN, U_Net.pdf; page=19; crop=architecture-only -->
