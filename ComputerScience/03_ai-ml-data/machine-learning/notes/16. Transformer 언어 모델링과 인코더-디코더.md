...
<div style="font-family:system-ui,-apple-system,sans-serif;padding:16px;background:var(--card);color:var(--card-foreground);border:1px solid var(--border);border-radius:var(--radius);display:flex;justify-content:center">
  <svg width="340" height="160" style="overflow:visible">
    <!-- 인코더 스택 (좌) -->
    <rect x="20" y="20" width="130" height="120" rx="6" fill="var(--background)" stroke="var(--chart-1)" stroke-width="2"/>
    <text x="85" y="40" font-size="11" font-weight="800" text-anchor="middle" fill="var(--chart-1)">인코더 (Encoder N×)</text>
    <rect x="35" y="55" width="100" height="24" rx="4" fill="var(--card)" stroke="var(--border)"/>
    <text x="85" y="71" font-size="9" font-weight="700" text-anchor="middle" fill="var(--foreground)">Feed Forward</text>
    <rect x="35" y="90" width="100" height="24" rx="4" fill="var(--card)" stroke="var(--border)"/>
    <text x="85" y="106" font-size="9" font-weight="700" text-anchor="middle" fill="var(--foreground)">Self-Attention</text>

    <!-- 디코더 스택 (우) -->
    <rect x="190" y="20" width="130" height="120" rx="6" fill="var(--background)" stroke="var(--chart-2)" stroke-width="2"/>
    <text x="255" y="40" font-size="11" font-weight="800" text-anchor="middle" fill="var(--chart-2)">디코더 (Decoder N×)</text>
    <rect x="205" y="55" width="100" height="20" rx="4" fill="var(--card)" stroke="var(--border)"/>
    <text x="255" y="69" font-size="8" font-weight="700" text-anchor="middle" fill="var(--foreground)">Feed Forward</text>
    <rect x="205" y="80" width="100" height="20" rx="4" fill="var(--card)" stroke="var(--border)"/>
    <text x="255" y="94" font-size="8" font-weight="700" text-anchor="middle" fill="var(--chart-1)">Cross-Attention (K,V)</text>
    <rect x="205" y="105" width="100" height="20" rx="4" fill="var(--card)" stroke="var(--border)"/>
    <text x="255" y="119" font-size="8" font-weight="700" text-anchor="middle" fill="var(--chart-2)">Masked Self-Attn</text>

    <!-- 인코더 ➔ 디코더 K, V 연결 화살표 -->
    <path d="M 150 80 L 205 90" fill="none" stroke="var(--primary)" stroke-width="2"/>
  </svg>
</div>
```
