...
**관계 계산의 범위.** attention은 토큰의 관계를 다루지만 입력 순서 정보는 positional encoding으로 별도 제공한다.
...
<details>
<summary>블록 순서</summary>

self-attention, Add & Norm, feed-forward의 순서를 인코더와 디코더에서 각각 확인한다.
