...
<div style="font-family:system-ui,sans-serif;padding:20px;display:flex;align-items:center;gap:20px;color:var(--foreground)">
  <svg width="120" height="120" viewBox="0 0 120 120" role="img" aria-label="two thirds of a variational loop completed">
    <circle cx="60" cy="60" r="46" stroke-width="14" style="fill: none; stroke: var(--border)" />
    <circle cx="60" cy="60" r="46" stroke-width="14"
      stroke-linecap="round" stroke-dasharray="289" stroke-dashoffset="95"
    ...
    <text x="60" y="67" text-anchor="middle" font-size="22" font-weight="700"
      style="fill: var(--foreground)">67%</text>
  </svg>
  <div>
    <div style="font-weight:600;font-size:15px">변분 루프</div>
    <div style="font-size:13px;color:var(--muted-foreground);margin-top:2px">측정값을 바탕으로 다음 회로 매개변수를 정한다.</div>
  </div>
</div>
```
