...
![차원 증가의 예시 비율을 보여 주는 원본 슬라이드](<../assets/3.-양자컴퓨팅을-위한-물리-및-선형대수_Jun.2026-p012.webp>)
...
![파울리 배타 원리 문구가 포함된 원본 슬라이드](<../assets/3.-양자컴퓨팅을-위한-물리-및-선형대수_Jun.2026-p013.webp>)
...
- 렌더 이미지: p.5, p.7, p.12, p.13, p.20 (실제 `assets/` 파일만 임베드)
