...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow669410" style="font-size:14px;font-weight:600">양자컴퓨팅을 위한 물리 및 선형대수 단계</label>
  <div id="noteFlow669410-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">양자컴퓨팅을 위한 물리 및 선형대수 핵심 개념</div>
  <input id="noteFlow669410" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow669410 = document.getElementById('noteFlow669410');
    var noteFlow669410Out = document.getElementById('noteFlow669410-out');
    var noteFlow669410Steps = ["양자컴퓨팅을 위한 물리 및 선형대수 핵심 개념","양자컴퓨팅을 위한 물리 및 선형대수 처리 절차","양자컴퓨팅을 위한 물리 및 선형대수 검증·응용"];
    noteFlow669410.addEventListener('input', function () { noteFlow669410Out.textContent = noteFlow669410Steps[Number(noteFlow669410.value) - 1]; });
  </script>
</div>
```
