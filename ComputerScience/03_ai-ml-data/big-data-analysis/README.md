---
title: 빅데이터 분석
description: '데이터 레이크, 분석 도구, MLFlow 과제. 학기: 3-2.'
type: course-index
tags:
- course
- 3-2
...
> [!abstract] 이 과목은
> 데이터 레이크, 분석 도구, MLFlow 과제. 학기: 3-2.
...
- `1 빅데이터 분석이란 (Updated 2025) 2.pdf`
- `1 빅데이터 분석이란 (Updated 2025).pdf`
- `2 하둡 및 분산 아키텍쳐.pdf`
- `3 아파치 스파크-Preview.pdf`
- `4-1 아파치 스파크-History.pdf`
- `4-2 아파치 스파크-Basics.pdf`
- `5 데이터 통계 기초.pdf`
- `6 변수 선택 (Variable Selection) 2.pdf`
- `6 변수 선택 (Variable Selection).pdf`
- `7 스트리밍 알고리즘.pdf`
- `8 다목적 최적화 2.pdf`
- `8 다목적 최적화.pdf`
- `MLFlow 설치 및 실행.pdf`
