...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow479453" style="font-size:14px;font-weight:600">변수 선택 단계</label>
  <div id="noteFlow479453-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">변수 선택 핵심 개념</div>
  <input id="noteFlow479453" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow479453 = document.getElementById('noteFlow479453');
    var noteFlow479453Out = document.getElementById('noteFlow479453-out');
    var noteFlow479453Steps = ["변수 선택 핵심 개념","변수 선택 처리 절차","변수 선택 검증·응용"];
    noteFlow479453.addEventListener('input', function () { noteFlow479453Out.textContent = noteFlow479453Steps[Number(noteFlow479453.value) - 1]; });
  </script>
</div>
```
