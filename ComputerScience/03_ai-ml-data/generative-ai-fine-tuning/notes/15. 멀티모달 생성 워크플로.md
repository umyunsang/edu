...
> [!caution] 원문·추출 표기
> Pika Labs 문맥 안에 `PicLab`이라는 다른 표기가 섞여 있다. AI 영화의 도구 목록에도 `Suno Al`, `Mid.Journey`가 남아 있다. 이 노트는 각각을 별도 제품으로 늘리지 않고, `Suno AI`, `Midjourney` 문맥에서 발생한 원문 오기 또는 추출 표기 차이로 명시한다.
...
<div style="font-family:system-ui,sans-serif;padding:20px">
  ...
  <script>
    var stats = [
      ['Runway Gen-1', '2023년 2월', '강의 자료의 공개 시점', 'var(--chart-2)'],
      ['Runway Gen-4', '2025년 3월 31일', '강의 자료의 공개 시점', 'var(--chart-1)'],
      ['Pika 2.2 generation', '최대 10초', '강의 자료의 길이 표기', 'var(--chart-5)']
    ];
