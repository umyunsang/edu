...
<div style="font-family:system-ui,sans-serif;padding:20px">
  ...
  <script>
    var stats = [
      ['ChatGPT 초기 도달', '100만 사용자', '출시 뒤 5일', 'var(--chart-1)'],
      ['국가 AI 제안', '15개 컨소시엄', '2025년 7월 본문', 'var(--chart-2)'],
      ['frontier 목표', '95% 이상', '강의 자료의 사업 목표', 'var(--chart-3)'],
      ['A100 단가 표기', '20,000달러', '강의 비용 화면', 'var(--chart-4)']
    ];
