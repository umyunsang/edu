...
> [!WARNING]
> 원문에는 추출 한계가 있다. 첫 표지는 제목만 남았고, 1,300억 원·1.76T·A100 20,000달러 등이 있는 자료는 관계를 설명할 텍스트가 부족하다. 두 소셜미디어 사례도 이미지 본문이 추출되지 않았다. 또한 모델 연도표와 2023년 11월 조직 명단은 원문 시점의 분류이며 현재 상태로 확대하지 않는다.
