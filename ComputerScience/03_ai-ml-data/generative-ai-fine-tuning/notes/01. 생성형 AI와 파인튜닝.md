...
>
> **원문·추출 오류.** OpenAI 설명에는 `afriendly`가 붙어 쓰여 있어 `a friendly`의 공백이 사라진 것으로 보인다. Y Combinator 설명에는 슬라이드 번호로 보이는 `4`가 문장 중간에 주입되어 있다. 두 표기를 조용히 정상 문장으로 바꾸거나 사실·수치로 사용하지 않는다.
