  ...
  <script>
    ...
    document.getElementById('bars26cost').innerHTML = data.map(function (d, i) {
      return '<div style="flex:1;display:flex;flex-direction:column;align-items:center;' +
        ...
        '<span style="font-size:12px;font-weight:600">' + d[1] + '달러</span>' +
...
<div style="font-family:system-ui,sans-serif;padding:20px">
  ...
  <script>
    var stats = [
      ['ReRoom style', '20개 이상', '강의 자료의 선택지', 'var(--chart-1)'],
      ['mnml.ai 도구', '12개 이상', '강의 자료의 기능 수', 'var(--chart-2)'],
      ['mnml.ai style', '40개 이상', '강의 자료의 style 수', 'var(--chart-3)'],
      ['Canva MAU', '6,000만 명', '2021년 강의 수치', 'var(--chart-4)'],
      ['InstantInterior 무료 결과', '5개', '고해상도·watermark 없음', 'var(--chart-5)']
    ];
