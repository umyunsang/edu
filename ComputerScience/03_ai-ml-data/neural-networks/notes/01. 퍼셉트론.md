  ...
  <div style="display:flex;gap:24px;align-items:center;flex-wrap:wrap">
    <div>
      <svg viewBox="0 0 220 200" style="width:220px;height:200px">
        ...
        <line x1="15" y1="90" x2="205" y2="195" stroke-width="2" style="stroke: var(--chart-5); opacity:.55" />
        <line x1="15" y1="175" x2="205" y2="35" stroke-width="2" style="stroke: var(--chart-4); opacity:.55" />
        <line x1="25" y1="195" x2="215" y2="55" stroke-width="2" style="stroke: var(--chart-3); opacity:.55" />
...
- **applies** — [02. 인공신경망과 활성화 함수](<./02. 인공신경망과 활성화 함수.md>) : 계단함수를 매끄러운 함수로 바꾸면 학습이 가능해진다
