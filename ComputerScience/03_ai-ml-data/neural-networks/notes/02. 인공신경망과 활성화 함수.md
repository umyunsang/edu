...
```html preview
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow869611" style="font-size:14px;font-weight:600">인공신경망과 활성화 함수 단계</label>
  <div id="noteFlow869611-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">인공신경망과 활성화 함수 핵심 개념</div>
  <input id="noteFlow869611" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow869611 = document.getElementById('noteFlow869611');
    var noteFlow869611Out = document.getElementById('noteFlow869611-out');
    var noteFlow869611Steps = ["인공신경망과 활성화 함수 핵심 개념","인공신경망과 활성화 함수 처리 절차","인공신경망과 활성화 함수 검증·응용"];
    noteFlow869611.addEventListener('input', function () { noteFlow869611Out.textContent = noteFlow869611Steps[Number(noteFlow869611.value) - 1]; });
  </script>
</div>
```
