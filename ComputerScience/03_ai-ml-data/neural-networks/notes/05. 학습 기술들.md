...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow891664" style="font-size:14px;font-weight:600">학습 기술들 단계</label>
  <div id="noteFlow891664-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">학습 기술들 핵심 개념</div>
  <input id="noteFlow891664" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow891664 = document.getElementById('noteFlow891664');
    var noteFlow891664Out = document.getElementById('noteFlow891664-out');
    var noteFlow891664Steps = ["학습 기술들 핵심 개념","학습 기술들 처리 절차","학습 기술들 검증·응용"];
    noteFlow891664.addEventListener('input', function () { noteFlow891664Out.textContent = noteFlow891664Steps[Number(noteFlow891664.value) - 1]; });
  </script>
</div>
```
