...
> [!quote] 슬라이드 근거
> `pdf/AIE309_5장_오차역전파.pdf` p.7–8, p.17–19
...
> [!quote] 슬라이드 근거
> `pdf/AIE309_5장_오차역전파.pdf` p.21–25
...
> [!quote] 슬라이드 근거
> `pdf/AIE309_5장_오차역전파.pdf` p.26–31
...
- **uses** — [02. 인공신경망과 활성화 함수](<./02. 인공신경망과 활성화 함수.md>) : $(AB)^{T} = B^{T}A^{T}$ 와 활성화 함수의 미분을 가져온다
- **applies-to** — [05. 학습 기술들](<./05. 학습 기술들.md>) : 역전파로 구한 기울기를 어떻게 쓸지가 다음 주제다
