...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow947473" style="font-size:14px;font-weight:600">오차역전파법 단계</label>
  <div id="noteFlow947473-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">오차역전파법 핵심 개념</div>
  <input id="noteFlow947473" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow947473 = document.getElementById('noteFlow947473');
    var noteFlow947473Out = document.getElementById('noteFlow947473-out');
    var noteFlow947473Steps = ["오차역전파법 핵심 개념","오차역전파법 처리 절차","오차역전파법 검증·응용"];
    noteFlow947473.addEventListener('input', function () { noteFlow947473Out.textContent = noteFlow947473Steps[Number(noteFlow947473.value) - 1]; });
  </script>
</div>
```
