...
> [!quote] 슬라이드 근거
> `pdf/3장_인공신경망.pdf` p.12, p.21–24, p.27
...
- **applies-to** — [03. 신경망 학습](<./03. 신경망 학습.md>) : 여기 세운 순전파에 손실함수와 경사하강법을 붙인다
- **uses** — [04. 오차역전파법](<./04. 오차역전파법.md>) : $(AB)^{T} = B^{T}A^{T}$ 가 역전파 유도에서 쓰인다
