...
> 이 교체 하나가 뒤의 모든 학습([[03. 신경망 학습|경사하강]]·[[04. 오차역전파법|역전파]])을 가능하게 만든다.
...
> 층이 깊어질수록 앞쪽 층이 학습되지 않는 이유이며, [[05. 학습 기술들|초기화 기법]]이 필요한 배경이다.
...
> 그리고 [[04. 오차역전파법|역전파]]의 Affine 계층이 정확히 이 식의 미분이다.
