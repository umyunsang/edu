...
| # | 노트 | 남기는 문제 |
| :-- | :-- | :-- |
| 01 | [퍼셉트론](<./01. 퍼셉트론.md>) | 직선 하나로는 XOR을 못 가른다 |
| 02 | [인공신경망과 활성화 함수](<./02. 인공신경망과 활성화 함수.md>) | 층은 쌓았는데, 무엇을 기준으로 학습하나 |
| 03 | [신경망 학습](<./03. 신경망 학습.md>) | 기울기를 수치미분으로 구하면 3억 번 계산이다 |
| 04 | [오차역전파법](<./04. 오차역전파법.md>) | 기울기는 구했는데 학습이 잘 안 된다 |
| 05 | [학습 기술들](<./05. 학습 기술들.md>) | — |
