...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow340001" style="font-size:14px;font-weight:600">LangChain 기반 RAG 챗봇 단계</label>
  <div id="noteFlow340001-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">LangChain 기반 RAG 챗봇 핵심 개념</div>
  <input id="noteFlow340001" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow340001 = document.getElementById('noteFlow340001');
    var noteFlow340001Out = document.getElementById('noteFlow340001-out');
    var noteFlow340001Steps = ["LangChain 기반 RAG 챗봇 핵심 개념","LangChain 기반 RAG 챗봇 처리 절차","LangChain 기반 RAG 챗봇 검증·응용"];
    noteFlow340001.addEventListener('input', function () { noteFlow340001Out.textContent = noteFlow340001Steps[Number(noteFlow340001.value) - 1]; });
  </script>
</div>
```
