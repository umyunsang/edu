...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow651477" style="font-size:14px;font-weight:600">점진 학습과 확률적 경사 하강법 단계</label>
  <div id="noteFlow651477-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">점진 학습과 확률적 경사 하강법 핵심 개념</div>
  <input id="noteFlow651477" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow651477 = document.getElementById('noteFlow651477');
    var noteFlow651477Out = document.getElementById('noteFlow651477-out');
    var noteFlow651477Steps = ["점진 학습과 확률적 경사 하강법 핵심 개념","점진 학습과 확률적 경사 하강법 처리 절차","점진 학습과 확률적 경사 하강법 검증·응용"];
    noteFlow651477.addEventListener('input', function () { noteFlow651477Out.textContent = noteFlow651477Steps[Number(noteFlow651477.value) - 1]; });
  </script>
</div>
```
