...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow9597311" style="font-size:14px;font-weight:600">기말 복습 지도 단계</label>
  <div id="noteFlow9597311-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">기말 복습 지도 핵심 개념</div>
  <input id="noteFlow9597311" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow9597311 = document.getElementById('noteFlow9597311');
    var noteFlow9597311Out = document.getElementById('noteFlow9597311-out');
    var noteFlow9597311Steps = ["기말 복습 지도 핵심 개념","기말 복습 지도 처리 절차","기말 복습 지도 검증·응용"];
    noteFlow9597311.addEventListener('input', function () { noteFlow9597311Out.textContent = noteFlow9597311Steps[Number(noteFlow9597311.value) - 1]; });
  </script>
</div>
```
