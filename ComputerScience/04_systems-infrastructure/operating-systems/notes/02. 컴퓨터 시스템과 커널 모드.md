...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow4261" style="font-size:14px;font-weight:600">컴퓨터 시스템과 커널 모드 단계</label>
  <div id="noteFlow4261-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">컴퓨터 시스템과 커널 모드 핵심 개념</div>
  <input id="noteFlow4261" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow4261 = document.getElementById('noteFlow4261');
    var noteFlow4261Out = document.getElementById('noteFlow4261-out');
    var noteFlow4261Steps = ["컴퓨터 시스템과 커널 모드 핵심 개념","컴퓨터 시스템과 커널 모드 처리 절차","컴퓨터 시스템과 커널 모드 검증·응용"];
    noteFlow4261.addEventListener('input', function () { noteFlow4261Out.textContent = noteFlow4261Steps[Number(noteFlow4261.value) - 1]; });
  </script>
</div>
```
