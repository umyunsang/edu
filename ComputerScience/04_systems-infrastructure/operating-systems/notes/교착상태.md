...
- 1. 교착상태 감지 및 복구(detection and recovery)
...
<!-- 원본 이미지 없음: operating-systems__Summary__은행원 알고리즘.png -->
...
<!-- 원본 이미지 없음: operating-systems__Summary__은행원 알고리즘에서 자원 할당 기준.png -->
- Need = Max - Alloc
- p0는 wait
...
<!-- 원본 이미지 없음: operating-systems__Summary__Resource-Allocation Graph Algorithm.png -->
...
<!-- 원본 이미지 없음: operating-systems__Summary__Resource-Allocation Graph (자원할당그래프 2.png -->
...
<!-- 원본 이미지 없음: operating-systems__Summary__Resource-Allocation Graph (자원할당그래프.png -->
...
<!-- 원본 이미지 없음: operating-systems__Summary__Deadlock Avoidance.png -->
...
## Banker's Algorithm
<!-- 원본 이미지 없음: operating-systems__Summary__Banker's Algorithm.png -->
