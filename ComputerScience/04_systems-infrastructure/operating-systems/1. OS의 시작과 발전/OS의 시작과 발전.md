...
<!-- 원본 이미지 없음: operating-systems__OS의 시작과 발전__운영체제와 응용소프트웨어.png -->
...
- CPU와 메모리 분리
- 소프트웨어와 하드웨어 분리
	<!-- 원본 이미지 없음: operating-systems__OS의 시작과 발전__2. 내장 프로그래밍 방식.png -->
...
<!-- 원본 이미지 없음: operating-systems__OS의 시작과 발전__배치 운영체제.png -->
...
<!-- 원본 이미지 없음: operating-systems__OS의 시작과 발전__다중 프로그래밍 운영체제 2.png -->
...
<!-- 원본 이미지 없음: operating-systems__OS의 시작과 발전__다중 프로그래밍 운영체제.png -->

## 시분할 다중프로그래밍 운영체제 (Time Sharing Multiprogramming)

<!-- 원본 이미지 없음: operating-systems__OS의 시작과 발전__시분할 다중프로그래밍 운영체제 (Time Sharing Multiprogr.png -->
