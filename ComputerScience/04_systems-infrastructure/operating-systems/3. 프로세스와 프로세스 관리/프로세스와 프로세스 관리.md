...
#### 프로세스 구성 - 4개의 메모리 영역
![[operating-systems__프로세스와 프로세스 관리__프로세스 구성 - 4개의 메모리 영역.png]]
1. **코드(code) 영역 <크기 고정>**
...
![[operating-systems__프로세스와 프로세스 관리__프로세스 주소 공간.png]]

![[operating-systems__프로세스와 프로세스 관리__프로세스 주소 공간 2.png]]
...
![[operating-systems__프로세스와 프로세스 관리__프로세스 테이블과 프로세스 제어 블록(PCB.png]]
...
![[operating-systems__프로세스와 프로세스 관리__프로세스 생명 주기와 상태 변이(state change.png]]
- **New(생성 상태)** 
...
- **Wait()** 
	...
	![[operating-systems__프로세스와 프로세스 관리__프로세스를 다루는 시스템 호출.png]]
...
- 부모 프로세스의 의무
	...
	![[operating-systems__프로세스와 프로세스 관리__좀비 프로세스 - 종료 후 방치된 자식 프로세스.png]]
...
- 프로세스 오버레이(process overlay)
	...
	![[operating-systems__프로세스와 프로세스 관리__프로세스 오버레이, exec.png]]
