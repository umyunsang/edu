...
[12_MPI 프로그래밍_V_02.pdf p.41](<../sources/12_MPI 프로그래밍_V_02.pdf>)
...
- [11. MPI 병렬 프로그래밍 I](<./11. MPI 병렬 프로그래밍 I.md>) — MPI 실행 모델과 rank·커뮤니케이터의 기초
- [09. GPU 아키텍처와 CUDA 프로그래밍 III](<./09. GPU 아키텍처와 CUDA 프로그래밍 III.md>) — 8절 MPI+CUDA 하이브리드의 CUDA 쪽 절반
- [06. 지역성·통신·경합](<./06. 지역성·통신·경합.md>) — 통신 비용과 블로킹 대기 시간의 성능 영향
- [04. 병렬 프로그래밍 기본](<./04. 병렬 프로그래밍 기본.md>) — 관리자–작업자 구조 등 병렬 패턴의 일반론
- [02. 병렬 컴퓨터의 기본 아키텍처](<./02. 병렬 컴퓨터의 기본 아키텍처.md>) — 노드·네트워크·클러스터의 하드웨어 배경
