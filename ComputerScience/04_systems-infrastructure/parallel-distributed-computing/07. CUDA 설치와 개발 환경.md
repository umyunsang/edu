...
prerequisites:: [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/06. 지역성·통신·경합|06. 지역성·통신·경합]]
next:: [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/08. GPU 아키텍처와 CUDA 프로그래밍 II|08. GPU 아키텍처와 CUDA 프로그래밍 II]]
...
> ([[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/06. 지역성·통신·경합|06. 지역성·통신·경합]] 의 경합 개념이 여기서 하드웨어 설계 근거로 등장한다)
...
![[pdf/07_GPU Architecture & CUDAProgramming_v01.pdf#page=12]]
...
>
> 이 문장은 [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/01. 왜 병렬 처리인가|01. 왜 병렬 처리인가]] 의
...
![[pdf/07_GPU Architecture & CUDAProgramming_v01.pdf#page=36]]
...
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/06. 지역성·통신·경합|06. 지역성·통신·경합]] — 커널 퓨전과 데이터 이동 비용의 원리편
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/08. GPU 아키텍처와 CUDA 프로그래밍 II|08. GPU 아키텍처와 CUDA 프로그래밍 II]] — 설치를 마친 뒤의 실제 CUDA 프로그래밍
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/09. GPU 아키텍처와 CUDA 프로그래밍 III|09. GPU 아키텍처와 CUDA 프로그래밍 III]] — GPU 아키텍처 심화
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/01. 왜 병렬 처리인가|01. 왜 병렬 처리인가]] — 데이터 이동 에너지 비용의 원출처
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/03. 멀티코어 아키텍처 II - 지연·대역폭과 ISPC|03. 멀티코어 아키텍처 II - 지연·대역폭과 ISPC]] — GPU 이전의 SIMD·지연 은닉 배경
