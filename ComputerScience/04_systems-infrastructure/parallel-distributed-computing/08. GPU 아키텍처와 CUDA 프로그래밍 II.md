...
prerequisites:: [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/07. CUDA 설치와 개발 환경|07. CUDA 설치와 개발 환경]]
next:: [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/09. GPU 아키텍처와 CUDA 프로그래밍 III|09. GPU 아키텍처와 CUDA 프로그래밍 III]]
...
![[pdf/08_GPU Architecture & CUDAProgramming_v02.pdf#page=46]]
...
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/07. CUDA 설치와 개발 환경|07. CUDA 설치와 개발 환경]] — 이 노트의 코드를 실제로 돌릴 환경 준비
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/09. GPU 아키텍처와 CUDA 프로그래밍 III|09. GPU 아키텍처와 CUDA 프로그래밍 III]] — 여기서 쓴 추상화가 SM·워프 위에서 **어떻게 구현되는지**
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/06. 지역성·통신·경합|06. 지역성·통신·경합]] — 공유 메모리와 halo가 해결하려는 통신 문제의 원리
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/04. 병렬 프로그래밍 기본|04. 병렬 프로그래밍 기본]] — 분해·할당·조정이라는 일반 틀에서 본 CUDA
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/01. 왜 병렬 처리인가|01. 왜 병렬 처리인가]] — 데이터 이동 비용이 왜 성능을 지배하는가
