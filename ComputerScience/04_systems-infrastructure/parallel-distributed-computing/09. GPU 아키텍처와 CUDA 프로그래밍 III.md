...
prerequisites:: [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/08. GPU 아키텍처와 CUDA 프로그래밍 II|08. GPU 아키텍처와 CUDA 프로그래밍 II]]
next:: [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/11. MPI 병렬 프로그래밍 I|11. MPI 병렬 프로그래밍 I]]
...
![[pdf/09_GPU Architecture & CUDAProgramming_v03.pdf#page=68]]
...
![[pdf/09_GPU Architecture & CUDAProgramming_v03.pdf#page=76]]
...
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/08. GPU 아키텍처와 CUDA 프로그래밍 II|08. GPU 아키텍처와 CUDA 프로그래밍 II]] — 이 노트가 "구현"을 설명하는 그 **CUDA 문법과 추상화**
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/03. 멀티코어 아키텍처 II - 지연·대역폭과 ISPC|03. 멀티코어 아키텍처 II - 지연·대역폭과 ISPC]] — 워프와 비교되는 ISPC 갱, 지연 은닉의 원리
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/05. 성능 최적화 I - 작업 분배와 스케줄링|05. 성능 최적화 I - 작업 분배와 스케줄링]] — 블록 스케줄러 = 동적 작업 분배, 워커 풀 패턴
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/02. 병렬 컴퓨터의 기본 아키텍처|02. 병렬 컴퓨터의 기본 아키텍처]] — SIMD / SIMT를 분류 체계 안에서 보기
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/06. 지역성·통신·경합|06. 지역성·통신·경합]] — 3종 주소 공간이 반영하는 지역성의 본편
