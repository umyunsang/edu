...
![[pdf/11_MPI 프로그래밍_V_01.pdf#page=25]]
...
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/12. MPI 병렬 프로그래밍 II|12. MPI 병렬 프로그래밍 II]] — 클러스터 구축과 Send/Recv 예제의 본편
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/02. 병렬 컴퓨터의 기본 아키텍처|02. 병렬 컴퓨터의 기본 아키텍처]] — 공유 메모리 / 분산 메모리 구조의 배경
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/04. 병렬 프로그래밍 기본|04. 병렬 프로그래밍 기본]] — 분할·할당·조율이라는 공통 프레임
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/06. 지역성·통신·경합|06. 지역성·통신·경합]] — 통신 비용이 성능을 갉아먹는 메커니즘
- [[ComputerScience/04_systems-infrastructure/parallel-distributed-computing/01. 왜 병렬 처리인가|01. 왜 병렬 처리인가]] — 멀티노드로 갈 수밖에 없는 이유
