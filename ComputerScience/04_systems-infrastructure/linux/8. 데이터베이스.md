...
<!-- 원본 이미지 없음: linux__MySQL 데이터베이스 연결 설정__CAP 이론.png -->
## MySQL
####  MySQL 기본 명령어
...
<!-- 원본 이미지 없음: linux__MySQL 데이터베이스 연결 설정__MySQL 기본 명령어.png -->
<!-- 원본 이미지 없음: linux__MySQL 데이터베이스 연결 설정__MySQL 기본 명령어 2.png -->
<!-- 원본 이미지 없음: linux__MySQL 데이터베이스 연결 설정__MySQL 기본 명령어 3.png -->
