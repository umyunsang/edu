...
- **컨테이너(Container)** 
	...
	- 가상머신(VM)보다 가볍고 빠름
#### VM과 도커
<!-- 원본 이미지 없음: container-orchestration__1. 베이스 이미지 선택__VM과 도커.png -->
#### 도커 구성요소
- **이미지(Image)** 
...
#### 도커 기본 명령어
- 이미지 관리
<!-- 원본 이미지 없음: container-orchestration__1. 베이스 이미지 선택__도커 기본 명령어.png -->
- 컨테이너 관리
<!-- 원본 이미지 없음: container-orchestration__1. 베이스 이미지 선택__도커 기본 명령어 2.png -->
- 그 외
<!-- 원본 이미지 없음: container-orchestration__1. 베이스 이미지 선택__도커 기본 명령어 3.png -->
---
#### 도커 기본 명령어 코드 실습
- 이미지 관리
```bash
