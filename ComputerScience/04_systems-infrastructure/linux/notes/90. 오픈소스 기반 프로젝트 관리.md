...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow9788814" style="font-size:14px;font-weight:600">오픈소스 기반 프로젝트 관리 단계</label>
  <div id="noteFlow9788814-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">오픈소스 기반 프로젝트 관리 핵심 개념</div>
  <input id="noteFlow9788814" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow9788814 = document.getElementById('noteFlow9788814');
    var noteFlow9788814Out = document.getElementById('noteFlow9788814-out');
    var noteFlow9788814Steps = ["오픈소스 기반 프로젝트 관리 핵심 개념","오픈소스 기반 프로젝트 관리 처리 절차","오픈소스 기반 프로젝트 관리 검증·응용"];
    noteFlow9788814.addEventListener('input', function () { noteFlow9788814Out.textContent = noteFlow9788814Steps[Number(noteFlow9788814.value) - 1]; });
  </script>
</div>
```
