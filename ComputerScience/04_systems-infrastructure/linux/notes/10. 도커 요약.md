...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  ...
  <script>
    var data = ["이미지",1],["컨테이너",2],["Dockerfile",3],["레지스트리",4]("이미지",1],["컨테이너",2],["Dockerfile",3],["레지스트리",4.md);
...
```html preview
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow6176411" style="font-size:14px;font-weight:600">도커 요약 단계</label>
  <div id="noteFlow6176411-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">도커 요약 핵심 개념</div>
  <input id="noteFlow6176411" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow6176411 = document.getElementById('noteFlow6176411');
    var noteFlow6176411Out = document.getElementById('noteFlow6176411-out');
    var noteFlow6176411Steps = ["도커 요약 핵심 개념","도커 요약 처리 절차","도커 요약 검증·응용"];
    noteFlow6176411.addEventListener('input', function () { noteFlow6176411Out.textContent = noteFlow6176411Steps[Number(noteFlow6176411.value) - 1]; });
  </script>
</div>
```
