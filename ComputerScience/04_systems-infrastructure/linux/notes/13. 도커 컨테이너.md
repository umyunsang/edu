...
<div style="font-family:system-ui,sans-serif;padding:20px">
  ...
  <script>
    var stats = ["실행","run","생성·실행","var(--chart-2)"],["조회","ps","실행 중 확인","var(--chart-1)"],["삭제","rm","종료 컨테이너","var(--chart-5)"]("실행","run","생성·실행","var(--chart-2)"],["조회","ps","실행 중 확인","var(--chart-1)"],["삭제","rm","종료 컨테이너","var(--chart-5)".md);
