...
<div style="font-family:system-ui,sans-serif;padding:20px">
  ...
  <script>
    var stats = ["위치","pwd","현재 위치 출력","var(--chart-2)"],["이동","cd","디렉터리 이동","var(--chart-1)"],["목록","ls","파일 확인","var(--chart-5)"]("위치","pwd","현재 위치 출력","var(--chart-2)"],["이동","cd","디렉터리 이동","var(--chart-1)"],["목록","ls","파일 확인","var(--chart-5)".md);
