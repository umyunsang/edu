...
> [!warning] 출처 경계
> 추출본의 문서 제목은 다른 과목명으로 표시된다. 이 노트는 확인 가능한 Flask·REST 본문만 사용했으며, 원본 시각자료·첨부물·페이지 표기는 넣지 않았다.
...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow680786" style="font-size:14px;font-weight:600">Flask와 REST 단계</label>
  <div id="noteFlow680786-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">Flask와 REST 핵심 개념</div>
  <input id="noteFlow680786" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow680786 = document.getElementById('noteFlow680786');
    var noteFlow680786Out = document.getElementById('noteFlow680786-out');
    var noteFlow680786Steps = ["Flask와 REST 핵심 개념","Flask와 REST 처리 절차","Flask와 REST 검증·응용"];
    noteFlow680786.addEventListener('input', function () { noteFlow680786Out.textContent = noteFlow680786Steps[Number(noteFlow680786.value) - 1]; });
  </script>
</div>
```
