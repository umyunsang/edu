...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow6498612" style="font-size:14px;font-weight:600">프로세스 기초 단계</label>
  <div id="noteFlow6498612-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">프로세스 기초 핵심 개념</div>
  <input id="noteFlow6498612" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow6498612 = document.getElementById('noteFlow6498612');
    var noteFlow6498612Out = document.getElementById('noteFlow6498612-out');
    var noteFlow6498612Steps = ["프로세스 기초 핵심 개념","프로세스 기초 처리 절차","프로세스 기초 검증·응용"];
    noteFlow6498612.addEventListener('input', function () { noteFlow6498612Out.textContent = noteFlow6498612Steps[Number(noteFlow6498612.value) - 1]; });
  </script>
</div>
```
