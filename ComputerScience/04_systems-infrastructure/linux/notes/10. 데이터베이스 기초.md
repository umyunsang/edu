...
<div style="font-family:system-ui,sans-serif;padding:20px">
  ...
  <script>
    var stats = ["모델","관계형","테이블 관계","var(--chart-2)"],["언어","SQL","질의 언어","var(--chart-1)"],["DBMS","MySQL","오픈소스","var(--chart-5)"]("모델","관계형","테이블 관계","var(--chart-2)"],["언어","SQL","질의 언어","var(--chart-1)"],["DBMS","MySQL","오픈소스","var(--chart-5)".md);
