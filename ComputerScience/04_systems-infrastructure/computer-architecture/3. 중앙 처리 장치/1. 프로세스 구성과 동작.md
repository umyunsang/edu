...
- 버스(Bus) : 장치 간에 주소, 데이터, 제어 신호를 전송하기 위한 연결 통로(연결선)
	...
	<!-- 원본 이미지 없음: computer-architecture__1. 프로세스 구성과 동작__1. 컴퓨터 기본 구조와 프로세서.png -->
...
- **16bit Address Bus를 갖는 CPU는 직접 지정할 수 있는 메모리 번지가 $2^{16}$ 개 있음**
	...
	<!-- 원본 이미지 없음: computer-architecture__1. 프로세스 구성과 동작__Address Bus.png -->
...
<!-- 원본 이미지 없음: computer-architecture__1. 프로세스 구성과 동작__3. 프로세서 기본 구조.png -->
- ALU
...
- Instruction Cycle
	...
	<!-- 원본 이미지 없음: computer-architecture__1. 프로세스 구성과 동작__Instruction Cycle Machine Cycle.png -->

#### `Opcode Fetch Cycle Timing Chart`

<!-- 원본 이미지 없음: computer-architecture__1. 프로세스 구성과 동작__Opcode Fetch Cycle Timing Chart.png -->
