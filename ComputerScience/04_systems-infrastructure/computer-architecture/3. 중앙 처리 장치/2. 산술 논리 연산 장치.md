...
- 논리 연산 : AND, OR, NOT, XOR, 시프트(shift)
	...
	<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘__산술 논리 연산 장치.png -->
...
- 1950년 영국 andrew Donald Booth에 의해 개발 -> 덧셈 횟수를 줄이는 알고리즘
	...
	<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘.png -->
...
### `(-7) * (+3)`
<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘__-7) (+3.png -->

### `22 * 17`
<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘__22 17.png -->
<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘__22 17 2.png -->
...
<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘__2. 논리 연산과 산술 시프트 연산.png -->

<!-- 원본 이미지 없음: computer-architecture__Booth 알고리즘__2. 논리 연산과 산술 시프트 연산 2.png -->
