...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow529897" style="font-size:14px;font-weight:600">중앙 처리 장치 단계</label>
  <div id="noteFlow529897-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">중앙 처리 장치 핵심 개념</div>
  <input id="noteFlow529897" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow529897 = document.getElementById('noteFlow529897');
    var noteFlow529897Out = document.getElementById('noteFlow529897-out');
    var noteFlow529897Steps = ["중앙 처리 장치 핵심 개념","중앙 처리 장치 처리 절차","중앙 처리 장치 검증·응용"];
    noteFlow529897.addEventListener('input', function () { noteFlow529897Out.textContent = noteFlow529897Steps[Number(noteFlow529897.value) - 1]; });
  </script>
</div>
```
