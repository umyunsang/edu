...
- [표 3-1]은 증명 없이 사용하기로 한 AND와 OR의 불 대수 공리다.
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__1. 불 대수 법칙.png -->
<!-- 원본 이미지 없음: computer-architecture__2. 불 대수__1. 불 대수 법칙 2.png -->
<!-- 원본 이미지 없음: computer-architecture__2. 불 대수__1. 불 대수 법칙 3.png -->

#### 진리표를 이용한 분배법칙 A+BC = (A+B)(A+C)의 증명

<!-- 원본 이미지 없음: computer-architecture__2. 불 대수__진리표를 이용한 분배법칙 A+BC (A+B)(A+C)의 증명.png -->

#### 진리표를 이용한 드모르간의 정리 증명

<!-- 원본 이미지 없음: computer-architecture__2. 불 대수__진리표를 이용한 드모르간의 정리 증명.png -->

- 드모르간의 정리는 논리 게이트로 표현할 수 있고 항이 많아도 동일하게 적용할 수 있다.
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__진리표를 이용한 드모르간의 정리 증명 2.png -->
...
- 곱의 합(SOP, Sum Of Product)은 1단계인 입력이 AND항(곱의 항)으로 구성되고, 2단계인 출력이 OR항(합의 항)으로 만들어진 논리식이다.
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__곱의 합과 최소항.png -->
- 최소항
  ...
  <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__곱의 합과 최소항 2.png -->
- 최소항 식
 	- 최소항 식은 출력이 1이 되는 항의 입력 변수를 AND 연산하고, 각 항을 OR 연산하는 식이다.
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__곱의 합과 최소항 3.png -->
- OR 게이트의 '곱의 합; minterm' 불 대수식 표현
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__곱의 합과 최소항 4.png -->

#### 합의 곱과 최대항

- 합의 곱(POS, Product Of Sum)은 1단계인 입력이 OR항(합의 항)으로 구성되고, 2단계인 출력이 AND항(곱의 항)으로 만들어진 논리식이다.
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__합의 곱과 최대항.png -->
- 최대항
  ...
  <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__합의 곱과 최대항 2.png -->
- 최대항 식
 	- 최대항 식은 출력이 0이 되는 항의 입력 변수를 OR 연산하고, 각 항을 AND 연산하는 식이다.
 <!-- 원본 이미지 없음: computer-architecture__2. 불 대수__합의 곱과 최대항 3.png -->

#### 최소항과 최대항의 관계

- 최소항 식은 출력이 1인 항을 곱의 합(SOP)으로 나타낸 것이고, 최대항 식은 출력이 0인 항을 합의 곱(POS)으로 나타낸 것이다.
- 따라서 최소항과 최대항은 서로 보수의 성질을 띤다고 할 수 있다.
<!-- 원본 이미지 없음: computer-architecture__2. 불 대수__최소항과 최대항의 관계.png -->
...
<!-- 원본 이미지 없음: computer-architecture__2. 불 대수__불 대수 법칙을 이용한 간소화.png -->
