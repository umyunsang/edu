...
- 레지스터 용도에 따른 종류
 ...
 <!-- 원본 이미지 없음: computer-architecture__3. 레지스터__레지스터 동작.png -->
...
- 힙 (Heap) 영역
 ...
 <!-- 원본 이미지 없음: computer-architecture__3. 레지스터__Memory Segments.png -->
...
<!-- 원본 이미지 없음: computer-architecture__3. 레지스터__BBo Als OS Sat HO AS St.png -->
