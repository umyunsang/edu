...
- 레지스터 R1에 상수 4를 저장하는 즉시 주소 지정 명령어의 예
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__1. 즉시 주소 지정 (immediate addressing mo.png -->
...
- 직접 주소 지정도 즉시 주소 지정처럼 사용 제한
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__2. 직접 주소 지정(direct addressing mode.png -->
...
- LOAD나 STORE 명령어
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__3. 레지스터 주소 지정 (register addressing m.png -->
...
- 직접 주소를 명령어에는 포함하지 않음
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__4. 레지스터 간접 주소 지정(register indirect a.png -->

<!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__4. 레지스터 간접 주소 지정(register indirect a 2.png -->
...
<!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__5. 변위 주소 지정(displacement addressing.png -->
...
- 예: 인덱스 주소 지정 방식은 인덱스 레지스터가 되고, 상대 주소 지정 방식에서는 PC가 특정 레지스터로 지정
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__인덱스 주소 지정(indexed addressing mode.png -->
...
- 명령어 루프에 4개 실행
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__인덱스 주소 지정(indexed addressing mode) 2.png -->

##### `상대 주소 지정(relative addressing mode)`

- ==PC 레지스터== 사용
- 현재 프로그램 코드가 실행되고 있는 위치에서 앞 또는 뒤로 일정한 변위만큼 떨어진 곳의 데이터 지정
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__상대 주소 지정(relative addressing mode.png -->
...
- 이 레지스터 중 하나를 베이스로 사용하여 실제 오퍼랜드 위치 지정
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__베이스 주소 지정 (base addressing mode.png -->
...
- 프로세서와 주기억 장치간의 속도 차가 많은 현재의 프로세서의 경우
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__6. 간접 주소 지정(indirect addressing mode.png -->
...
- Core i7, ARM 및 AVR에서 사용되는 주소 지정 방식
 ...
 <!-- 원본 이미지 없음: computer-architecture__5. 주소 지정 방식__9. 실제 프로세서에서 주소 지정 방식.png -->
