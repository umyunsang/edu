...
## 1. LAN 계층
#### LAN의 계층 구조
<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__LAN의 계층 구조.png -->
...
- LLC는 사용방식에 따라 다음과 같이 3가지의 종류로 나뉨
	<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__논리 연결 제어(LLC.png -->

#### 매체 접근 제어(MAC)
<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__매체 접근 제어(MAC.png -->
...
####  CSMA/CD
<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__CSMA CD.png -->
...
<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__CSMA CD 2.png -->
...
#### 토큰 링
<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__토큰 링.png -->
...
## 3. 데이터 링크 계층 프레임 분석
#### HDLC 프레임
<!-- 원본 이미지 없음: computer-networks__기말 암기 정리__HDLC 프레임.png -->
...
#### 이더넷 프레임
<!-- 원본 이미지 없음: computer-networks__LAN의 특징과 규격__이더넷 프레임.png -->
