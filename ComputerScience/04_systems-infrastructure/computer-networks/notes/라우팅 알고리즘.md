...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow6022617" style="font-size:14px;font-weight:600">라우팅 알고리즘 단계</label>
  <div id="noteFlow6022617-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">라우팅 알고리즘 핵심 개념</div>
  <input id="noteFlow6022617" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow6022617 = document.getElementById('noteFlow6022617');
    var noteFlow6022617Out = document.getElementById('noteFlow6022617-out');
    var noteFlow6022617Steps = ["라우팅 알고리즘 핵심 개념","라우팅 알고리즘 처리 절차","라우팅 알고리즘 검증·응용"];
    noteFlow6022617.addEventListener('input', function () { noteFlow6022617Out.textContent = noteFlow6022617Steps[Number(noteFlow6022617.value) - 1]; });
  </script>
</div>
```
