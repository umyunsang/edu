...
<div style="font-family:system-ui,sans-serif;padding:20px;color:var(--foreground)">
  <label for="noteFlow3876814" style="font-size:14px;font-weight:600">네트워크 보안 단계</label>
  <div id="noteFlow3876814-out" style="font-size:26px;font-weight:700;color:var(--chart-1);margin:6px 0">네트워크 보안 핵심 개념</div>
  <input id="noteFlow3876814" type="range" min="1" max="3" step="1" value="1" style="width:100%;accent-color:var(--primary)" />
  <p style="font-size:13px;color:var(--muted-foreground)">슬라이더를 움직이면 원본 PDF에서 정리한 이 노트의 흐름을 확인합니다.</p>
  <script>
    var noteFlow3876814 = document.getElementById('noteFlow3876814');
    var noteFlow3876814Out = document.getElementById('noteFlow3876814-out');
    var noteFlow3876814Steps = ["네트워크 보안 핵심 개념","네트워크 보안 처리 절차","네트워크 보안 검증·응용"];
    noteFlow3876814.addEventListener('input', function () { noteFlow3876814Out.textContent = noteFlow3876814Steps[Number(noteFlow3876814.value) - 1]; });
  </script>
</div>
```
