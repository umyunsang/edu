...
up:: [[ComputerScience/2-1_data-structures/1. 리스트/리스트|리스트]]
prerequisites:: [[ComputerScience/2-1_python/1. 변수와 자료형|1. 변수와 자료형]]
related:: [[ComputerScience/2-1_data-structures/1. 리스트/단순 연결 리스트|단순 연결 리스트]], [[ComputerScience/2-1_data-structures/1. 리스트/이중 연결 리스트|이중 연결 리스트]], [[ComputerScience/2-1_data-structures/3. 큐/Queue|Queue]]
