...
related:: [[ComputerScience/3-1_mathematical-logic/프로젝트/이상 탐지(ASD)를 위한 최적의 Feature Engineering|이상 탐지(ASD)를 위한 최적의 Feature Engineering]], [[ComputerScience/3-1_mathematical-logic/프로젝트/2차 컨펌|2차 컨펌]], [[ComputerScience/3-1_mathematical-logic/프로젝트/ASD Feature 발굴|ASD Feature 발굴]]
