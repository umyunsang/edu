# MSC087 최적화수학 HOMEWORK 2 풀이

**제출 기한**: 2025.12.07, 22:00 pm
...
모든 문제의 풀이를 단계별로 상세하게 작성했습니다. 각 문제는 다음 순서로 정리되어 있습니다:

1. **문제 설명** - 원 문제 재확인
2. **단계별 풀이** - Step by Step 상세 풀이
3. **최종 답** - 박스 처리된 명확한 답

LaTeX 수식과 옵시디언 마크다운 서식을 사용하여 가독성을 높였습니다.
