...
up:: [[ComputerScience/2-2_database/7. 데이터베이스 언어 SQL/데이터 베이스 언어 SQL|데이터 베이스 언어 SQL]]
prerequisites:: [[ComputerScience/2-1_python/1. 변수와 자료형|1. 변수와 자료형]], [[ComputerScience/2-1_linux/1. 리눅스의 기본|1. 리눅스의 기본]]
related:: [[ComputerScience/2-2_database/1. 기본 개념/기본 개념|기본 개념]], [[ComputerScience/2-2_database/0. 시험/중간 주관식 예상|중간 주관식 예상]], [[ComputerScience/2-2_database/4. 데이터 모델링/데이터 모델링|데이터 모델링]]
