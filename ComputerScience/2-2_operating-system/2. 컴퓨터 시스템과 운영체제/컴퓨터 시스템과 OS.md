...
up:: [[ComputerScience/2-2_operating-system/12. 저장 장치 관리/대용량 저장 장치 관리|대용량 저장 장치 관리]]
...
related:: [[ComputerScience/2-2_operating-system/1. OS의 시작과 발전/OS의 시작과 발전|OS의 시작과 발전]], [[ComputerScience/2-2_operating-system/3. 프로세스와 프로세스 관리/프로세스와 프로세스 관리|프로세스와 프로세스 관리]], [[ComputerScience/2-2_operating-system/8. 메모리관리/메모리 관리|메모리 관리]]
