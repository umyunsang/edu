...
related:: [[ComputerScience/2-2_operating-system/과제/MemoryAlloc/allocation.c|allocation.c]], [[ComputerScience/2-2_operating-system/4. 스레드와 멀티테스킹/스레드와 멀티테스킹|스레드와 멀티테스킹]], [[ComputerScience/2-2_operating-system/7. 교착상태/교착상태|교착상태]]
