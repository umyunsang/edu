...
siblings:: [[ComputerScience/2-1_linux/0. 리눅스 소개|0. 리눅스 소개]], [[ComputerScience/2-1_linux/1. 리눅스의 기본|1. 리눅스의 기본]], [[ComputerScience/2-1_linux/10. 도커|10. 도커]], [[ComputerScience/2-1_linux/2. 리눅스 VI|2. 리눅스 VI]], [[ComputerScience/2-1_linux/3. 리눅스 셸|3. 리눅스 셸]], [[ComputerScience/2-1_linux/4. 리눅스 권한|4. 리눅스 권한]], [[ComputerScience/2-1_linux/6. REST|6. REST]], [[ComputerScience/2-1_linux/7. 회원 가입 및 로그인|7. 회원 가입 및 로그인]]
---
## 파이썬 플라스크 (Flask)
#### 파이썬 플라스크 (Flask)
- 플라스크란? 
