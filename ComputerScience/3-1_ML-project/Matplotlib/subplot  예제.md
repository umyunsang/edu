...
related:: [[ComputerScience/3-1_ML-project/Matplotlib/subplot 생성|subplot 생성]], [[ComputerScience/3-1_ML-project/Matplotlib/크기조정 및 그리드|크기조정 및 그리드]], [[ComputerScience/3-1_ML-project/Matplotlib/imshow 이미지 그래프|imshow 이미지 그래프]]
