...
related:: [[ComputerScience/3-1_ML-project/Matplotlib/imshow 이미지 그래프|imshow 이미지 그래프]], [[ComputerScience/3-1_ML-project/Matplotlib/그래프 스타일|그래프 스타일]], [[ComputerScience/3-1_ML-project/Matplotlib/scatter 산점도 그래프|scatter 산점도 그래프]]
