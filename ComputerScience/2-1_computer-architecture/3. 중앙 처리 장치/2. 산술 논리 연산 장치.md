...
siblings:: [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/1. 프로세스 구성과 동작|1. 프로세스 구성과 동작]], [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/3. 레지스터|3. 레지스터]], [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/4. 컴퓨터 명령어|4. 컴퓨터 명령어]], [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/5. 주소 지정 방식|5. 주소 지정 방식]], [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/6. CISC와 RISC|6. CISC와 RISC]]
---
#### 산술 논리 연산 장치 
