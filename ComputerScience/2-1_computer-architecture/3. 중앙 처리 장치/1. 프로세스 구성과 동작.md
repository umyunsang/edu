...
related:: [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/3. 레지스터|3. 레지스터]], [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/4. 컴퓨터 명령어|4. 컴퓨터 명령어]], [[ComputerScience/2-1_computer-architecture/3. 중앙 처리 장치/6. CISC와 RISC|6. CISC와 RISC]]
