...
related:: [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/3. 실수 표현|3. 실수 표현]], [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/1. 진법과 진법 변환|1. 진법과 진법 변환]], [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/4. 디지털 코드|4. 디지털 코드]]
