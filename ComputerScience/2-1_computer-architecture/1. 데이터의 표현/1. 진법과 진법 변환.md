...
siblings:: [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/2. 정수 표현|2. 정수 표현]], [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/3. 실수 표현|3. 실수 표현]], [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/4. 디지털 코드|4. 디지털 코드]], [[ComputerScience/2-1_computer-architecture/1. 데이터의 표현/5. 에러 검출 코드|5. 에러 검출 코드]]
---
## `Number System;`
