...
related:: [[ComputerScience/2-1_computer-architecture/2. 디지털 논리 회로/2. 불 대수|2. 불 대수]], [[ComputerScience/2-1_computer-architecture/2. 디지털 논리 회로/4. 조합 논리 회로|4. 조합 논리 회로]], [[ComputerScience/2-1_computer-architecture/2. 디지털 논리 회로/3. 카르노 맵|3. 카르노 맵]]
