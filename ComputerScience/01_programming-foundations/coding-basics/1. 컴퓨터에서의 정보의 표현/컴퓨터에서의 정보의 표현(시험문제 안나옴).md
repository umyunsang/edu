...
- 정보를 표현하는 단위
	...
	2. 바이트(byte) : 8bit
		![[coding-basics__만둣국 맛있겠다__컴퓨터에서의 정보의 표현.png]]
...
![[coding-basics__만둣국 맛있겠다__파형의 종류(시험) 2.png]]

2. 정형파, 사인파 (Sine Wave)
정형파는 일반적으로 사인파를 의미합니다.

![[coding-basics__만둣국 맛있겠다__파형의 종류(시험.png]]

3. 삼각파, 트라이앵글파 (Triangle Wave)
삼각파는 트라이앵글파라고도 불립니다.

![[coding-basics__만둣국 맛있겠다__파형의 종류(시험) 3.png]]

4. 톱니파, 램프파 (Sawtooth Wave)
톱니파는 램프파라고도 불립니다.

![[coding-basics__만둣국 맛있겠다__파형의 종류(시험) 4.png]]
