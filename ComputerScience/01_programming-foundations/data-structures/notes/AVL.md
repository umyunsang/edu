...
- 왼쪽 서브 트리의 왼쪽 서브 트리에 노드가 추가되면서 불균형이 발생했을 때 사용
 ...
 <!-- 원본 이미지 없음: data-structures__AVL__AVL 트리의 회전 연산.png -->

**RR 회전

- 오른쪽 서브 트리의 오른쪽 서브 트리에 노드가 추가되면서 불균형이 발생했을 때 사용

 <!-- 원본 이미지 없음: data-structures__AVL__AVL 트리의 회전 연산 2.png -->

**LR 회전

- 왼쪽 서브 트리의 오른쪽 서브 트리에 노드가 추가되면서 불균형이 발생했을 때 사용

 <!-- 원본 이미지 없음: data-structures__AVL__AVL 트리의 회전 연산 3.png -->

**RL 회전

- 오른쪽 서브 트리의 왼쪽 서브 트리에 노드가 추가되면서 불균형이 발생했을 때 사용

 <!-- 원본 이미지 없음: data-structures__AVL__AVL 트리의 회전 연산 4.png -->

## AVL 트리 코드 구현

#### AVl 트리 코드 구현

<!-- 원본 이미지 없음: data-structures__AVL__AVl 트리 코드 구현.png -->
<!-- 원본 이미지 없음: data-structures__AVL__AVl 트리 코드 구현 2.png -->
<!-- 원본 이미지 없음: data-structures__AVL__AVl 트리 코드 구현 3.png -->
<!-- 원본 이미지 없음: data-structures__AVL__AVl 트리 코드 구현 4.png -->
