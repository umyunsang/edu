...
description: Convert DOCX files into Markdown files with metadata, headings, inline formatting, tables, and extracted images. Use when the user asks to extract or convert Word documents to Markdown.
---
