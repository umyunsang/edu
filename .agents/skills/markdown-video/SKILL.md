...
```bash
cd "{slides_directory}"
python /Users/lifidea/.Codex/skills/markdown-video/generate_audio.py "{slides_filename}" --output-dir "audio"
```
...
```bash
cd "{slides_directory}"
python /Users/lifidea/.Codex/skills/markdown-video/create_slides_gemini.py "{slides_filename}" \
...
```bash
cd "{slides_directory}"
python /Users/lifidea/.Codex/skills/markdown-video/slides_to_video.py \
...
python /Users/lifidea/.Codex/skills/markdown-video/generate_audio.py "slides.md" --output-dir "audio"

# Step 2: Generate slide images
python /Users/lifidea/.Codex/skills/markdown-video/create_slides_gemini.py "slides.md" \
  --output-dir "slides-gemini" \
  --style "technical-diagram" \
  --auto-approve
...
```bash
cd "{slides_directory}"
python /Users/lifidea/.Codex/skills/markdown-video/generate_section_images.py "{slides_filename}" \
...
```bash
cd "{slides_directory}"
python /Users/lifidea/.Codex/skills/markdown-video/create_video_script.py "{slides_filename}" \
...
```bash
cd "{slides_directory}"
python /Users/lifidea/.Codex/skills/markdown-video/create_section_video.py \
...
python /Users/lifidea/.Codex/skills/markdown-video/generate_section_images.py "slides.md" \
  --output-dir "slides-section" \
  --style "infographic"

# Step 3 (optional): Create review document
python /Users/lifidea/.Codex/skills/markdown-video/create_video_script.py "slides.md" \
  --output "video_script.md" \
  --image-dir "slides-section"
