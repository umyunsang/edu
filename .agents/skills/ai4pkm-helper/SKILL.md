...
- **Executor**: AI engine to run (Codex, codex_cli, gemini_cli)
...
| `executor` | | 실행 엔진 | `Codex`, `codex_cli`, `gemini_cli` |
...
| 필드 | 설명 | 예시 |
|------|------|------|
| `executor` | 실행 엔진 | `Codex`, `gemini_cli` |
| `label` | Worker 식별 라벨 | `Codex`, `Gemini` |
| `output_path` | Worker별 출력 경로 | `AI/Summary/Codex` |
...
Agent: 각 모델 결과를 어디에 저장할까요?
       예: AI/Compare/Codex, AI/Compare/Gemini
```
...
### Design Documents
- `[[AI/Analysis/2025-12-10 AI4PKM Onboarding Agent Design - Codex]]`
